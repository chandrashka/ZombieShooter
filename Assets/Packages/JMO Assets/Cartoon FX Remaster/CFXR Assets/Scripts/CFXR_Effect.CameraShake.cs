...
namespace CartoonFX
{
    public partial class CFXR_Effect : MonoBehaviour
    {
        ...
        public class CameraShake
        {
            ...
            [Space] [Range(0, 0.1f)] public float shakesDelay;
            ...
            public void fetchCameras()
            {
                ...
                foreach (var cam in cameras)
                {
                    ...
                    if (!camerasPreRenderPosition.ContainsKey(cam)) camerasPreRenderPosition.Add(cam, Vector3.zero);
                }
            }
