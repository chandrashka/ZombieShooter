...
namespace Opsive.UltimateCharacterController.Demo
{
    ...
    {
        [Tooltip("The Collider that should be disabled.")] [SerializeField]
        protected Collider m_DisableCollider;
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (characterLocomotion.gameObject != m_DemoManager.Character) return;
