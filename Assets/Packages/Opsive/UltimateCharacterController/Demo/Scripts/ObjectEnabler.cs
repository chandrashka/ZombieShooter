...
namespace Opsive.UltimateCharacterController.Demo
{
    ...
    {
        [Tooltip("Specifies the objects that should be enabled when in the trigger zone.")] [SerializeField]
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            for (var i = 0; i < m_Objects.Length; ++i) m_Objects[i].SetActive(true);
        }
        ...
        {
            if (m_ActiveObject != other.gameObject) return;
            m_ActiveObject = null;
