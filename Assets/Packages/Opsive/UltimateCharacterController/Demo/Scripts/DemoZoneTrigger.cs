...
namespace Opsive.UltimateCharacterController.Demo
{
    ...
    public class DemoZoneTrigger : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (characterLocomotion == null || characterLocomotion.gameObject != m_DemoManager.Character) return;

            if (m_DemoManager.EnteredTriggerZone(this, other.gameObject)) m_EnterExitCount++;
        }
        ...
        private void OnTriggerExit(Collider other)
        {
            ...
            m_EnterExitCount--;
            if (m_EnterExitCount == 0) m_DemoManager.ExitedTriggerZone(this);
        }
    }
}