...
namespace Opsive.UltimateCharacterController.Demo
{
    ...
    {
        [Tooltip("The ItemDefinition used by the flashlight.")] [SerializeField]
        protected ItemDefinitionBase m_FlashlightItemDefinition;

        [Tooltip("The light within the cave.")] [SerializeField]
        ...
        {
            if (item.ItemDefinition != m_FlashlightItemDefinition) return;
