...
namespace Opsive.UltimateCharacterController.Demo
{
    ...
    {
        [Tooltip("The doors that should be opened.")] [SerializeField]
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (other.gameObject.GetCachedParentComponent<UltimateCharacterLocomotion>() == null) return;

            // Open all of the doors.
            for (var i = 0; i < m_Doors.Length; ++i) m_Doors[i].OpenClose(true, true, false);
