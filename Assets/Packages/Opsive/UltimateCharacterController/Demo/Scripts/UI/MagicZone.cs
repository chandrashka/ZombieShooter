...
namespace Opsive.UltimateCharacterController.Demo.UI
{
    ...
    {
        [Tooltip("A mapping of the ItemDefinitions to the button.")] [SerializeField]
        protected ItemDefinitionBase[] m_ItemDefinitions;
        ...
        [Tooltip("The Particle Stream Item Definition.")] [SerializeField]
        protected ItemDefinitionBase m_ParticleStreamItemDefinition;

        [Tooltip("A reference to the Attribute Monitor for the Particle Stream.")] [SerializeField]
        protected GameObject m_ParticleStreamAttributeMonitor;
        ...
        private void Start()
        {
            var character = FindObjectOfType<DemoManager>().Character;
            ...
            for (var i = 0; i < m_Objects.Length; ++i) m_Objects[i].SetActive(false);
        ...
        {
            for (var i = 0; i < m_ActiveItemSets.Length; ++i)
        ...
        {
            if (itemIndex < 0 || itemIndex >= m_ItemDefinitions.Length || itemIndex == m_Index) return;
            ...
            for (var i = 0; i < m_Objects[m_Index].transform.childCount; ++i)
        ...
        protected override void CharacterExit(UltimateCharacterLocomotion characterLocomotion)
        {
            ...
            for (var i = 0; i < m_ActiveItemSets.Length; ++i)
            {
                if (m_ActiveItemSets[i] == -1) continue;
