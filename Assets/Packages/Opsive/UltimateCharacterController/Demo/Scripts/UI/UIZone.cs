...
namespace Opsive.UltimateCharacterController.Demo.UI
{
    ...
    {
        [Tooltip("A reference to the UI parent GameObject.")] [SerializeField]
        protected GameObject m_UIParent;

        [Tooltip(
            "A reference to the buttons that correspond to the InputTypes. These buttons must be in the same order as the enum.")]
        [SerializeField]
        protected Image[] m_ButtonImages;
        ...
        protected virtual void Awake()
        {
            ...
            {
                if (m_ButtonImages[i] == null) continue;
        ...
        {
            if (m_ActiveCharacter == null) return;
