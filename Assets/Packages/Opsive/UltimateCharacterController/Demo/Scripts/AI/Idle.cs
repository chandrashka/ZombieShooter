...
{
    /// <summary>
    ///     The Idle Movement Type will ensure the AI character doesn't move. A regular Movement Type could have also been used
    ///     but there isn't a common Movement Type included
