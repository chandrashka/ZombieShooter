...
namespace Opsive.UltimateCharacterController.SurfaceSystem
{
    ...
    public class SurfaceType : ScriptableObject
    {
        ...
        [SerializeField]
        protected ImpactEffect[] m_ImpactEffects;

        [Tooltip("Does the SurfaceType allow footprints?")] [SerializeField]
        protected bool m_AllowFootprints = true;

        public ImpactEffect[] ImpactEffects => m_ImpactEffects;
        public bool AllowFootprints => m_AllowFootprints;
    }
}