...
namespace Opsive.UltimateCharacterController.UI
{
    ...
    {
        [Tooltip(
            "The AttributeManager that contains the attribute. If null the character's Attribute Manager will be used.")]
        [SerializeField]
        protected AttributeManager m_AttributeManager;

        [Tooltip("The name of the attribute that the UI should monitor.")] [SerializeField]
        protected string m_AttributeName = "Health";

        [Tooltip("A reference used to the slider used to show the attribute value.")] [SerializeField]
        ...
        protected override void Awake()
        {
            ...
            if (m_AttributeManager != null)
                EventHandler.RegisterEvent<Attribute>(m_AttributeManager.gameObject, "OnAttributeUpdateValue",
                    OnUpdateValue);
        ...
        protected override void OnDestroy()
        {
            ...
            if (m_AttributeManager != null)
                EventHandler.UnregisterEvent<Attribute>(m_AttributeManager.gameObject, "OnAttributeUpdateValue",
                    OnUpdateValue);
        }
        ...
        {
            if (attribute != m_Attribute) return;
