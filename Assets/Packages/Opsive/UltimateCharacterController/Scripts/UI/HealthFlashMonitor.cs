...
namespace Opsive.UltimateCharacterController.UI
{
    ...
    public class HealthFlashMonitor : CharacterMonitor
    {
        ...
        protected Flash m_DamageFlash = new(true, new Color(1, 0, 0, 0.7f), 1.5f, 1f);

        [Tooltip("The flash when the character is healed.")] [SerializeField]
        protected Flash m_HealFlash = new(true, new Color(1, 1, 1, 0.2f), 0.05f, 0.2f);
        ...
        private void Update()
        {
            ...
            if (alpha <= 0) m_GameObject.SetActive(false);
        }
        ...
        protected override void OnAttachCharacter(GameObject character)
        {
            ...
            if (m_Character == null || m_GameObject == null) return;
        ...
        {
            if (!m_DamageFlash.CanActivate) return;
        ...
        {
            if (!m_HealFlash.CanActivate) return;
        ...
        public struct Flash
        {
            ...
            public float VisiblityDuration => m_VisiblityDuration;
