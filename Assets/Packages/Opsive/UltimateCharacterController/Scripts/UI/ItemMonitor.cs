...
namespace Opsive.UltimateCharacterController.UI
{
    ...
    {
        [Tooltip("A reference to the text used for primary ItemType count.")] [SerializeField]
        protected Text m_PrimaryCount;
        ...
        protected override void OnAttachCharacter(GameObject character)
        {
            if (m_Character != null)
            {
                EventHandler.UnregisterEvent<IItemIdentifier, int, bool, bool>(m_Character,
                ...
                EventHandler.UnregisterEvent<Item, IItemIdentifier, int>(m_Character,
                    "OnItemUseConsumableItemIdentifier", OnUseConsumableItemIdentifier);
                EventHandler.UnregisterEvent<IItemIdentifier, int>(m_Character, "OnInventoryAdjustItemIdentifierAmount",
            ...
            if (m_CharacterInventory == null) return;
            gameObject.SetActive(CanShowUI());

            EventHandler.RegisterEvent<IItemIdentifier, int, bool, bool>(m_Character, "OnInventoryPickupItemIdentifier",
                OnPickupItemIdentifier);
            EventHandler.RegisterEvent<Item, bool>(m_Character, "OnItemUpdateDominantItem", OnUpdateDominantItem);
            EventHandler.RegisterEvent<Item, IItemIdentifier, int>(m_Character, "OnItemUseConsumableItemIdentifier",
                OnUseConsumableItemIdentifier);
            EventHandler.RegisterEvent<IItemIdentifier, int>(m_Character, "OnInventoryAdjustItemIdentifierAmount",
                OnAdjustItemIdentifierAmount);
        }
        ...
        protected virtual void OnPickupItemIdentifier(IItemIdentifier itemIdentifier, int amount, bool immediatePickup,
            bool forceEquip)
        {
        }
