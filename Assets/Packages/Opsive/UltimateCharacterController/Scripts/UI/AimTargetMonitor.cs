...
namespace Opsive.UltimateCharacterController.UI
{
    ...
    {
        [Tooltip("The aim image that will move on screen space to point at the target.")] [SerializeField]
        protected Image m_AimImage;

        [Tooltip("The Screen space offset for the image.")] [SerializeField]
        protected Vector2 m_ScreenSpaceOffset;

        [Tooltip("The soft aim icon.")] [SerializeField]
        protected Sprite m_SoftAimIcon;

        [Tooltip("The locked aim icon.")] [SerializeField]
        protected Sprite m_LockedAimIcon;

        [Tooltip("The default color of the soft aim icon.")] [SerializeField]
        protected Color m_SoftAimColor = Color.white;

        [Tooltip("The color of the aim icon a target locked.")] [SerializeField]
        protected Color m_LockedAimColor = Color.red;
        ...
        protected override void Awake()
        {
            ...
            if (m_AimImage == null) m_AimImage = GetComponent<Image>();
        ...
        {
            if (m_Character != null)
                EventHandler.UnregisterEvent<Transform, bool>(m_Character, "OnCombatAimTargetChange",
                    OnAimTargetChange);
