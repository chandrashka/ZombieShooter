...
namespace Opsive.UltimateCharacterController.Networking.Character
{
    ...
    public interface INetworkCharacter
    {
        ...
        void MeleeHitCollider(ItemAction itemAction, int hitboxIndex, RaycastHit raycastHit, GameObject hitGameObject,
        ...
        void MagicImpact(ItemAction itemAction, uint castID, GameObject source, GameObject target, Vector3 position,
            Vector3 normal);
