...
{
    /// <summary>
    ///     The QuickSelect algorithm is a selection algorithm that uses a similar method as the QuickSort sorting algorithm.
    ...
    public class QuickSelect
    {
        ...
        /// <param name="k">
        ///     The nth smallest value to retrieve. 0 indicates the smallest element, endIndex - 1 indicates the
        ///     largest.
        /// </param>
        ...
        {
            if (k > arrayCount - 1) k = arrayCount - 1;
        ...
        private static T SmallestK<T>(T[] array, int startIndex, int endIndex, int k, IComparer<T> comparer)
        {
            ...
            if (pivotIndex < k) return SmallestK(array, pivotIndex + 1, endIndex, k, comparer);
        ...
        /// <summary>
        ///     Partition the array into two groups based on the pivot. All values smaller than the pivot will be moved to the
        ///     left, and all values greater will be moved
        ...
        {
            var pivotIndex = Random.Range(startIndex, endIndex + 1);
