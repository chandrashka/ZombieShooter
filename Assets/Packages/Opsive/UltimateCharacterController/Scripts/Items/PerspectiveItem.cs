...
{
    /// <summary>
    ///     Component which represents the item object actually rendererd. The main responsibility is to determine the location
    ///     that the object should be rendered at.
    /// </summary>
    public abstract class PerspectiveItem : StateBehavior
    {
        ...
        [Tooltip("If Object is a prefab, specifies the local position of the spawned object.")] [SerializeField]
        protected Vector3 m_LocalSpawnPosition;

        [Tooltip("If Object is a prefab, specifies the local rotation of the spawned object.")] [SerializeField]
        protected Vector3 m_LocalSpawnRotation;

        [Tooltip("If Object is a prefab, specifies the local scale of the spawned object.")] [SerializeField]
        protected Vector3 m_LocalSpawnScale = Vector3.one;
        ...
        public virtual bool Initialize(GameObject character)
        {
            ...
            if (m_Object != null)
            {
                ...
                if (m_Object.layer == m_Character.layer)
                    Debug.LogWarning(
                        $"Warning: The item {name} has the same layer as the character. This will likely cause collision problems and should be changed.");
            }
        ...
        public virtual void SetActive(bool active, bool hasItem)
        {
        ...
        public virtual void ResetInitialization()
        {
            ...
            if (visibleObject != null) visibleObject.transform.SetParent(m_Item.transform);
        }
    }
}