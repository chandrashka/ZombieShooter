...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public interface IReloadableItem
    {
        ...
        /// <summary>
        ///     Specifies if the item should wait for the OnAnimatorItemReload animation event or wait for the specified duration
        ///     before reloading.
        /// </summary>
        ...
        /// <summary>
        ///     Specifies if the item should wait for the OnAnimatorItemReloadComplete animation event or wait for the specified
        ///     duration before reloading.
        /// </summary>
        /// <returns>
        ///     Value of if the item should use the OnAnimatorItemReloadComplete animation event or wait the specified
        ///     duration.
        /// </returns>
