...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public class Flashlight : UsableItem
    {
        ...
        [HideInInspector]
        [SerializeField]
        protected AttributeModifier m_BatteryModifier = new("Battery", 0, Attribute.AutoUpdateValue.Decrease);

        private IFlashlightPerspectiveProperties m_FlashlightPerpectiveProperties;

        public AttributeModifier BatteryModifier
        {
            get => m_BatteryModifier;
            set => m_BatteryModifier = value;
        }
        ...
        protected override void Awake()
        {
            ...
            if (m_BatteryModifier != null)
                if (m_BatteryModifier.Initialize(m_GameObject))
                    EventHandler.RegisterEvent(m_BatteryModifier.Attribute, "OnAttributeReachedDestinationValue",
                        OnBatteryEmpty);
        }
        ...
        protected override void Start()
        {
            ...
            if (m_FlashlightPerpectiveProperties == null)
            {
                ...
                if (m_FlashlightPerpectiveProperties == null)
                    Debug.LogError(
                        "Error: The First/Third Person Flashlight Item Properties component cannot be found for the Item " +
                        name + "." +
                        "Ensure the component exists and the component's Action ID matches the Action ID of the Item (" +
                        m_ID + ")");
            }
        }
        ...
        protected override void OnDestroy()
        {
            ...
            if (m_BatteryModifier != null && m_BatteryModifier.Attribute != null)
                EventHandler.UnregisterEvent(m_BatteryModifier.Attribute, "OnAttributeReachedDestinationValue",
                    OnBatteryEmpty);
        }
        ...
        public override bool CanUseItem(ItemAbility itemAbility, UseAbilityState abilityState)
        {
            ...
            if (m_BatteryModifier != null && !m_BatteryModifier.IsValid()) return false;
...
#endif
            if (m_BatteryModifier != null) m_BatteryModifier.EnableModifier(active);
        }
        ...
        protected override void OnChangePerspectives(bool firstPersonPerspective)
        {
            ...
            m_FlashlightPerpectiveProperties = m_ActivePerspectiveProperties as IFlashlightPerspectiveProperties;
            if (active) m_FlashlightPerpectiveProperties.Light.SetActive(true);
        }
    }
}