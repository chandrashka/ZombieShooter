...
namespace Opsive.UltimateCharacterController.Items.Actions.Magic.CastActions
{
    ...
    public class PlayAudioClip : CastAction
    {
        ...
        [Tooltip("The duration of the AudioSource fade. Set to 0 to disable fading out.")] [SerializeField]
        ...
        public override void Cast(Transform origin, Vector3 direction, Vector3 targetPosition)
        {
            ...
            m_AudioSource = AudioManager
                .PlayAtPosition(audioClip, m_PlayAtOrigin ? origin.position : m_GameObject.transform.position)
                .AudioSource;
