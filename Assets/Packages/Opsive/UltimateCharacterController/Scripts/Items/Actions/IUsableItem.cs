...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public interface IUsableItem
    {
        ...
        /// <summary>
        ///     Specifies if the item should wait for the OnAnimatorItemUse animation event or wait for the specified duration
        ///     before reloading.
        /// </summary>
        ...
        /// <summary>
        ///     Specifies if the item should wait for the OnAnimatorItemUseComplete animation event or wait for the specified
