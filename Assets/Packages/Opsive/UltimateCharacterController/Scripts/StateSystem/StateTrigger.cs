...
namespace Opsive.UltimateCharacterController.StateSystem
{
    ...
    {
        [Tooltip("The name of the state to activate/deactivate.")] [SerializeField]
        ...
        protected AudioClipSet m_ActivateAudioClipSet = new();
        ...
        private void Awake()
        {
            if (string.IsNullOrEmpty(m_StateName)) enabled = false;
        }
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if ((m_RequireCharacter &&
                 (stateBehavior = other.GetComponentInParent<UltimateCharacterLocomotion>()) != null) ||
        ...
        {
            if (m_Duration > 0 || !MathUtility.InLayerMask(other.gameObject.layer, m_LayerMask)) return;
                ...
                (!m_RequireCharacter && (stateBehavior = other.GetComponentInParent<StateBehavior>()) != null))
            {
                ...
                else
                {
                    ...
                    if (health != null && !health.IsAlive())
                    {
                        ...
                        if (m_DeathDeactivations == null) m_DeathDeactivations = new List<GameObject>();
                    ...
                    if (m_CharacterTransformChange)
                        EventHandler.ExecuteEvent(stateBehavior.gameObject, "OnCharacterImmediateTransformChange",
                            true);
                }
            }
        }
        ...
        private void ChangeState(GameObject stateGameObject, bool activate)
        {
            ...
            if (activate && m_Duration > 0) SchedulerBase.Schedule(m_Duration, ChangeState, stateGameObject, false);
        }
        ...
        {
            for (var i = m_DeathDeactivations.Count - 1; i > -1; --i)
            {
