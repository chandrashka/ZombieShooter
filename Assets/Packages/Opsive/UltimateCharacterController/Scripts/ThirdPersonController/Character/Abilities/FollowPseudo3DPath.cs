...
namespace Opsive.UltimateCharacterController.ThirdPersonController.Character.Abilities
{
    ...
    public class FollowPseudo3DPath : Ability
    {
        ...
        private Pseudo3D m_Pseudo3DMovementType;
        ...
        public override void Awake()
        {
            ...
            EventHandler.RegisterEvent<MovementType, bool>(m_GameObject, "OnCharacterChangeMovementType",
        ...
        {
            if (!(movementType is Pseudo3D)) return;

            if (!IsActive && active)
            {
                // If the movement type is active then the ability should start if a path exists.
                var pseudo3DMovementType = movementType as Pseudo3D;
        ...
        public override bool CanStartAbility()
        {
            ...
            return m_CharacterLocomotion.ActiveMovementType is Pseudo3D &&
                   (m_CharacterLocomotion.ActiveMovementType as Pseudo3D).Path != null;
        }
        ...
        protected override void AbilityStarted()
        {
            ...
            m_Pseudo3DMovementType = m_CharacterLocomotion.ActiveMovementType as Pseudo3D;
            ...
            var pathRotation =
                Quaternion.LookRotation(m_Pseudo3DMovementType.Path.GetTangent(m_Transform.position, ref m_PathIndex));
        ...
        {
            if (m_Pseudo3DMovementType.Path == null) StopAbility();
        }
        ...
        public override void UpdatePosition()
        {
            ...
            var pathRotation =
                Quaternion.LookRotation(m_Pseudo3DMovementType.Path.GetTangent(targetPosition, ref m_PathIndex));
            ...
            targetPosition =
                MathUtility.TransformPoint(targetPosition, pathRotation, Vector3.right * (offset - m_Offset));
        ...
        public override void OnDestroy()
        {
            ...
            EventHandler.UnregisterEvent<MovementType, bool>(m_GameObject, "OnCharacterChangeMovementType",
                OnCharacterChangeMovementType);
        }
    }
}