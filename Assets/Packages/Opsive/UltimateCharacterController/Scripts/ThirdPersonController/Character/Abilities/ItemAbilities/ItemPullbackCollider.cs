...
namespace Opsive.UltimateCharacterController.ThirdPersonController.Character.Abilities.Items
{
    ...
    {
        [Tooltip("The offset to apply to the transform relative to the starting local position.")] [SerializeField]
        protected Vector3 m_LocalPositionOffset;

        [Tooltip("The offset to apply to the radius to the starting radius.")] [SerializeField]
