...
{
    /// <summary>
    ///     The Combat View Type will inherit the functionality from the Third Person View Type while keeping the camera
    ///     rotated to the same local yaw value
    ///     as the character.
    /// </summary>
    [RecommendedMovementType(typeof(Character.MovementTypes.Combat))]
    [RecommendedMovementType(typeof(FourLegged))]
    [AddState("Zoom", "edafe89541fb59d4dba60703f5b1574a")]
