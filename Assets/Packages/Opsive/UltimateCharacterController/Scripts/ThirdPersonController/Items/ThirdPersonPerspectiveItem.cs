...
namespace Opsive.UltimateCharacterController.ThirdPersonController.Items
{
    ...
    public class ThirdPersonPerspectiveItem : PerspectiveItem
    {
        ...
        [Tooltip(
            "The ID of the ObjectIdentifier component belong to the Transform that specifies the location of the non-dominant hand. This ID will be used when hand IK Target is null and the the ID is not -1.")]
        [SerializeField]
        protected int m_NonDominantHandIKTargetID = -1;
        ...
        [Tooltip(
            "The ID of the ObjectIdentifier component belong to the Transform that specifies the location of the non-dominant hand hint. This ID will be used when hand IK Target Hint is null and the the ID is not -1.")]
        [SerializeField]
        protected int m_NonDominantHandIKTargetHintID = -1;

        [Tooltip("The transform that the item should be holstered to when unequipped.")] [SerializeField]
        protected Transform m_HolsterTarget;

        [Tooltip(
            "The ID of the ObjectIdentifier component that the item should be holstered to when unequipped. This ID will be used when holster target is null and the the ID is not -1.")]
        [SerializeField]
        ...
        [NonSerialized]
        public Transform NonDominantHandIKTarget
        {
            get => m_NonDominantHandIKTarget;
            set => m_NonDominantHandIKTarget = value;
        }

        [NonSerialized]
        public int NonDominantHandIKTargetID
        {
            get => m_NonDominantHandIKTargetID;
            set => m_NonDominantHandIKTargetID = value;
        }

        [NonSerialized]
        public Transform NonDominantHandIKTargetHint
        {
            get => m_NonDominantHandIKTargetHint;
            set => m_NonDominantHandIKTargetHint = value;
        }

        [NonSerialized]
        public int NonDominantHandIKTargetHintID
        {
            get => m_NonDominantHandIKTargetHintID;
            set => m_NonDominantHandIKTargetHintID = value;
        }
        ...
        public override bool Initialize(GameObject character)
        {
            ...
            if (!base.Initialize(character)) return false;
            ...
            {
                var objectIDs = m_Character.GetComponentsInChildren<ObjectIdentifier>();
        ...
        public override void SetActive(bool active, bool hasItem)
        {
            ...
            if (m_HolsterTarget != null && hasItem)
            {
                ...
                if (m_Object != null) base.SetActive(true, true);
            }
            ...
            if (m_CharacterIK != null)
                m_CharacterIK.SetItemIKTargets(active ? m_ObjectTransform : null, m_ParentBone,
                    active ? m_NonDominantHandIKTarget : null, active ? m_NonDominantHandIKTargetHint : null);
        }
        ...
        public override void Pickup()
        {
            ...
            if (m_HolsterTarget != null) m_HolsterTarget.gameObject.SetActive(true);
        }
        ...
        private void OnDeath(Vector3 position, Vector3 force, GameObject attacker)
        {
            ...
            if (m_HolsterTarget != null && m_PickedUp) m_HolsterTarget.gameObject.SetActive(false);
        }
        ...
        {
            if (m_HolsterTarget != null && m_PickedUp) m_HolsterTarget.gameObject.SetActive(true);
        }
