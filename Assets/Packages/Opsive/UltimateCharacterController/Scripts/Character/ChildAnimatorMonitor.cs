        ...
        private void Awake()
        {
            ...
            if (m_CharacterAnimatorMonitor.HasItemParameters)
            {
                ...
                for (var i = 0; i < slotCount; ++i)
                {
                    ...
                    for (var j = 0; j < m_Animator.parameterCount; ++j)
            ...
            m_HasVRParameters =
 handHandler != null && m_GameObject.GetComponent<FirstPersonController.Character.Identifiers.FirstPersonBaseObject>() != null;
            ...
            OnChangeUpdateLocation(m_CharacterLocomotion.UpdateLocation ==
            ...
            if (enabled)
            {
                ...
                EventHandler.RegisterEvent<bool>(m_Character, "OnCharacterChangeUpdateLocation",
        ...
        public void SnapAnimator()
        {
            ...
            if (m_GameObject == null || !m_GameObject.activeInHierarchy) return;
            ...
            if (m_CharacterAnimatorMonitor.HasItemParameters)
                for (var i = 0; i < m_CharacterAnimatorMonitor.ParameterSlotCount; ++i)
                {
            ...
            while (IsInTrasition()) m_Animator.Update(Time.fixedDeltaTime);
            m_Animator.Update(0);
        ...
        {
            if (!m_ItemParameterExists.Contains(slotID)) return;
...
#endif
#if UNITY_EDITOR
            if (m_CharacterAnimatorMonitor.LogEvents) Debug.Log("Execute " + eventName);
#endif
        ...
        private void OnDestroy()
        {
            if (m_CharacterAnimatorMonitor != null)
            {
                ...
                EventHandler.UnregisterEvent<bool>(m_Character, "OnCharacterChangeUpdateLocation",
                    OnChangeUpdateLocation);
