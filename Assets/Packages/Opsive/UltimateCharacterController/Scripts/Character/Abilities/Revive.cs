...
{
    /// <summary>
    ///     The Revive ability will play a standing animation from laying on the ground. The OnRespawn event will be executed
    ...
    public class Revive : Ability
    {
        ...
        [SerializeField]
        protected float m_DeathStartDelay = 3;

        private Respawner m_Respawner;

        private int m_ReviveTypeIndex;

        [Tooltip("Should the ability start when the character dies?")] [SerializeField]
        protected bool m_StartOnDeath;
        ...
        public float DeathStartDelay
        {
            get => m_DeathStartDelay;
            set => m_DeathStartDelay = value;
        }

        public override bool CanStayActivatedOnDeath => true;

        public override int AbilityIntData => m_ReviveTypeIndex;
        ...
        public override void Awake()
        {
            ...
            {
                Debug.LogError(
                    "Error: The Revive ability requires the Respawner component to be added to the character.");
                return;
            }
        ...
        private void OnReviveComplete()
        {
            ...
            if (!m_CharacterLocomotion.Alive) m_Respawner.Respawn();
        }
