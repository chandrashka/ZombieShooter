...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class LookAt : DetectObjectAbilityBase
    {
        ...
        [Tooltip("The target object should be within the specified field of view (degrees).")] [SerializeField]
        protected float m_FieldOfView = 160f;

        [Tooltip("The transform that the character should look from.")] [SerializeField]
        protected Transform m_Origin;

        private readonly HashSet<Ability> m_PreventativeAbilities = new();
        ...
        public override void Awake()
        {
            ...
            if (m_Origin == null)
            {
                ...
                if (animator != null) m_Origin = animator.GetBoneTransform(HumanBodyBones.Head);
                if (m_Origin == null) m_Origin = m_Transform;
            }
        ...
        {
            if (m_CharacterIK == null || m_PreventativeAbilities.Count > 0) return false;
        ...
        public override void Update()
        {
            ...
            {
                if (!m_DetectedTriggerObjects[i].activeSelf) continue;
                ...
                if (Vector3.Angle(direction, m_Transform.forward) > m_FieldOfView * 0.5f) continue;
            ...
            if (closestObject != null)
            {
                ...
                targetPosition =
                    closestObject.transform.TransformPoint(pivotOffset != null ? pivotOffset.Offset : Vector3.zero);
            }
            else
            {
