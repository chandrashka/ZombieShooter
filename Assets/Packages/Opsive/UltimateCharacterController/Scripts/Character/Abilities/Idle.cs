...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class Idle : Ability
    {
        ...
        [Tooltip("The maximum AbilityFloatData animator parameter.")] [SerializeField]
        protected float m_MaxAbilityFloatDataValue;

        [Tooltip("The maximum amount of time that the current AbilityFloatData value should be set.")] [SerializeField]
        protected float m_MaxDuration = 10;

        [Tooltip("The minimum amount of time that the current AbilityFloatData value should be set.")] [SerializeField]
        protected float m_MinDuration = 5;

        [Tooltip(
            "Should a random int between 0 and MaxAbilityFloatDataValue be used? If false AbilityFloatData will be increased sequentially.")]
        [SerializeField]
        protected bool m_RandomValue = true;

        [Tooltip("Specifies how long the ability should wait until it is started.")] [SerializeField]
        protected float m_StartDelay = 15;

        public float MaxAbilityFloatDataValue
        {
            get => m_MaxAbilityFloatDataValue;
            set => m_MaxAbilityFloatDataValue = value;
        }

        public bool RandomValue
        {
            get => m_RandomValue;
            set => m_RandomValue = value;
        }
        ...
        public override float AbilityFloatData => m_AbilityFloatDataValue;
        ...
        public override bool CanStartAbility()
        {
            ...
            if (m_CanStartTime != -1) m_CanStartTime = -1;
            return false;
        }
        ...
        private void DetermineAbilityFloatDataValue()
        {
            ...
            m_FloatChangeEvent = SchedulerBase.ScheduleFixed(Random.Range(m_MinDuration, m_MaxDuration),
                DetermineAbilityFloatDataValue);
        }
