...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class QuickStart : StoredInputAbilityBase
    {
        ...
        protected override bool RequireInput => false;
        public override int AbilityIntData => m_StartIndex;
        ...
        protected override void AbilityStarted()
        {
            ...
            else if (inputValue.x < 0) m_StartIndex = (int)StartIndex.WalkStrafeLeft;
