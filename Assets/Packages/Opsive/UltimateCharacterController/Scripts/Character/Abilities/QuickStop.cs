...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class QuickStop : StoredInputAbilityBase
    {
        ...
        [Tooltip(
            "The number of times CanStartAbility must return true before the ability actually starts. Will prevent the ability from starting too soon.")]
        [SerializeField]
        protected int m_RequiredStartSuccessCount = 2;
        ...
        [Tooltip("The threshold which indicates when the character has stopped.")] [SerializeField]
        protected float m_StopThreshold = 0.01f;
        ...
        {
            get => m_StopThreshold;
            set => m_StopThreshold = value;
        }

        public int RequiredStartSuccessCount
        {
            get => m_RequiredStartSuccessCount;
            set => m_RequiredStartSuccessCount = value;
        }

        protected override bool UseRawInput => false;
        protected override bool RequireInput => true;
        public override int AbilityIntData => m_StopIndex;
        ...
        public override bool CanStartAbility()
        {
            ...
            if (m_CharacterLocomotion.RawInputVector.sqrMagnitude > m_StopThreshold) return false;
            ...
            if (m_AverageInput.sqrMagnitude < 0.01f) return false;
        ...
        protected override void AbilityStarted()
        {
            ...
            if (m_StartSuccessCount == 0) DeterminStopIndex();
        ...
        private void DeterminStopIndex()
        {
            ...
            else if (m_AverageInput.x < 0) m_StopIndex = (int)StopIndex.WalkStrafeLeft;
        }
        ...
        public override void Update()
        {
            ...
            {
                if (!CanStartAbility()) StopAbility();
                m_StartSuccessCount--;
                if (m_StartSuccessCount == 0)
                {
                    DeterminStopIndex();
