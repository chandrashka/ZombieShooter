...
namespace Opsive.UltimateCharacterController.Character.Abilities.AI
{
    ...
    {
        [Tooltip("Can the character apply new accelerations while in the air?")] [SerializeField]
        protected bool m_AllowMovementInAir = true;

        public bool AllowMovementInAir
        {
            get => m_AllowMovementInAir;
            set => m_AllowMovementInAir = value;
        }
