...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    {
        [Tooltip("Specifies the index of the item state within the animator.")] [SerializeField]
        protected int m_ItemStateIndex = -1;

        public virtual int ItemStateIndex
        {
            get => m_ItemStateIndex;
            set => m_ItemStateIndex = value;
        }
        ...
        public override bool ShouldBlockAbilityStart(Ability startingAbility)
        {
            ...
            if (startingAbility is StoredInputAbilityBase) return true;
