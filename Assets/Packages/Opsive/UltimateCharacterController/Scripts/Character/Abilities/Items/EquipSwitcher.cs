...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    public abstract class EquipSwitcher : ItemSetAbilityBase
    {
        ...
        public override void Awake()
        {
            ...
            EventHandler.RegisterEvent<int>(m_EquipUnequipItemAbility, "OnEquipUnequipItemSetIndexChange",
        ...
        public override void OnDestroy()
        {
            ...
            if (m_EquipUnequipItemAbility != null)
            {
                EventHandler.UnregisterEvent<int>(m_EquipUnequipItemAbility, "OnEquipUnequipItemSetIndexChange",
                    OnItemSetIndexChange);
