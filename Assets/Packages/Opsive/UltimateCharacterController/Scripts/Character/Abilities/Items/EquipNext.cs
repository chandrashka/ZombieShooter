...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    public class EquipNext : EquipSwitcher
    {
        ...
        public override void Awake()
        {
            ...
            if (m_EquipUnequipItemAbility == null) return;
        ...
        private void OnNextItemSet(Item item, bool unequipOnFailure)
        {
            ...
            if (!m_ItemSetManager.IsCategoryMember(itemIdentifier.GetItemDefinition(), m_ItemSetCategoryIndex)) return;
            ...
            if (itemIdentifier != activeItemIdentifier) return;
            ...
            if (!StartAbility() && unequipOnFailure)
                m_EquipUnequipItemAbility.StartEquipUnequip(
                    m_ItemSetManager.GetDefaultItemSetIndex(m_ItemSetCategoryIndex));
        }
