...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    {
        [Tooltip("Should the ability activate when the first person perspective is enabled?")] [SerializeField]
        protected bool m_ActivateInFirstPerson = true;

        private bool m_AIAgent;
        private bool m_FirstPersonPerspective;
#if THIRD_PERSON_CONTROLLER
        private ItemPullback m_ItemPullback;
#endif
        ...
        [Tooltip("When the Aim ability is activated should it stop the speed change ability?")] [SerializeField]
        protected bool m_StopSpeedChange = true;

        public bool StopSpeedChange
        {
            get => m_StopSpeedChange;
            set => m_StopSpeedChange = value;
        }

        public bool ActivateInFirstPerson
        {
            get => m_ActivateInFirstPerson;
            set => m_ActivateInFirstPerson = value;
        }
...
#if THIRD_PERSON_CONTROLLER
            m_ItemPullback = m_CharacterLocomotion.GetAbility<ItemPullback>();
#endif
        ...
        private void OnChangePerspectives(bool firstPersonPerspective)
        {
            ...
            if (m_ActivateInFirstPerson)
            {
                ...
                else if (IsActive && !firstPersonPerspective && !InputStart)
                {
        ...
        public override int GetItemStateIndex(int slotID)
        {
            ...
            if (m_ItemPullback != null && m_ItemPullback.IsActive) return -1;
#endif
            ...
            if (item != null && item.DominantItem)
            {
                ...
                for (var i = 0; i < itemActions.Length; ++i)
                {
                    ...
                    if (usableItem != null)
                    {
                        ...
                        if (substateIndex != -1) return substateIndex;
                    }
                }
            }

            return InputStart ? 1 : 0;
        }
        ...
        {
            if (InputStart) return false;
#if THIRD_PERSON_CONTROLLER
            if (m_ItemPullback != null && m_ItemPullback.IsActive) return false;
#endif
        ...
        private bool PreventAbility(Ability activeAbility)
        {
            ...
            if (m_StopSpeedChange && (InputIndex != -1 || InputStart) && activeAbility is SpeedChange) return true;
        ...
        protected override void AbilityStarted()
        {
            ...
            EventHandler.ExecuteEvent(m_GameObject, "OnAimAbilityStart", true, InputStart);
        ...
        public override void UpdateRotation()
        {
            ...
            if (m_CharacterLocomotion.ActiveMovementType.UseIndependentLook(true)) return;
        ...
        {
            if (m_ActivateInFirstPerson && !InputStart) return false;
        ...
        public override bool CanStopAbility()
        {
            if (m_ActivateInFirstPerson && m_FirstPersonPerspective)
            {
                ...
                if (InputStart)
                {
                    ...
                    EventHandler.ExecuteEvent(m_GameObject, "OnAimAbilityStart", false, InputStart);
                    InputStart = false;
        ...
        protected override void AbilityStopped(bool force)
        {
            ...
            if (m_PerspectiveSwitch && !InputStart)
            {
                if (m_AIAgent) base.AbilityStopped(force);
                return;
            }
        ...
        protected override bool ShouldCheckInput()
        {
            return false;
        }
        ...
        private void OnItemAbilityActive(ItemAbility itemAbility, bool active)
        {
            ...
            if (IsActive && itemAbility.Index > Index && (itemAbility is Use
                ...
                Debug.Log(
                    $"Warning: The ability {itemAbility.GetType().Name} started but it has a lower priority than the aim ability." +
        ...
        {
            if (m_ActivateInFirstPerson && m_CharacterLocomotion.FirstPersonPerspective) StartAbility();
        }
