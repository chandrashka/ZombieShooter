...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    {
        [Tooltip("The ID of the ItemAction component that can be used.")] [SerializeField]
        protected int m_ActionID;

        private bool m_AIAgent;

        [Tooltip("Should the use be blocked when the cursor is over a UI object?")] [SerializeField]
        protected bool m_BlockOverUI = true;
        ...
        [Tooltip("Should the ability rotate the character to face the look source target?")] [SerializeField]
        protected bool m_RotateTowardsLookSourceTarget = true;

        [Tooltip("The slot that should be used. -1 will use all of the slots.")] [SerializeField]
        ...
        public bool RotateTowardsLookSourceTarget
        {
            get => m_RotateTowardsLookSourceTarget;
            set => m_RotateTowardsLookSourceTarget = value;
        }

        public bool BlockOverUI
        {
            get => m_BlockOverUI;
            set => m_BlockOverUI = value;
        }

        public IUsableItem[] UsableItems => m_UsableItems;
        public Item FaceTargetItem { get; private set; }
        ...
        public override string AbilityDescription
        {
            get
            {
                ...
                if (m_SlotID != -1) description += "Slot " + m_SlotID;
                if (m_ActionID != 0)
                {
        ...
        private void RegisterSlotEvents(int slotID)
        {
            ...
            if (slotID == 0)
            {
                ...
                EventHandler.RegisterEvent(m_GameObject, "OnAnimatorItemUseCompleteFirstSlot",
                    OnItemUseCompleteFirstSlot);
            }
            else if (slotID == 1)
            {
                EventHandler.RegisterEvent(m_GameObject, "OnAnimatorItemUseSecondSlot", OnItemUseSecondSlot);
                EventHandler.RegisterEvent(m_GameObject, "OnAnimatorItemUseCompleteSecondSlot",
                    OnItemUseCompleteSecondSlot);
            }
            else if (slotID == 2)
            {
                EventHandler.RegisterEvent(m_GameObject, "OnAnimatorItemUseThirdSlot", OnItemUseThirdSlot);
                EventHandler.RegisterEvent(m_GameObject, "OnAnimatorItemUseCompleteThirdSlot",
                    OnItemUseCompleteThirdSlot);
            }
            else if (slotID != -1)
            {
        ...
        private void UnregisterSlotEvents(int slotID)
        {
            ...
            if (slotID == 0)
            {
                ...
                EventHandler.UnregisterEvent(m_GameObject, "OnAnimatorItemUseCompleteFirstSlot",
                    OnItemUseCompleteFirstSlot);
            }
            else if (slotID == 1)
            {
                EventHandler.UnregisterEvent(m_GameObject, "OnAnimatorItemUseSecondSlot", OnItemUseSecondSlot);
                EventHandler.UnregisterEvent(m_GameObject, "OnAnimatorItemUseCompleteSecondSlot",
                    OnItemUseCompleteSecondSlot);
            }
            else if (slotID == 2)
            {
                EventHandler.UnregisterEvent(m_GameObject, "OnAnimatorItemUseThirdSlot", OnItemUseThirdSlot);
                EventHandler.UnregisterEvent(m_GameObject, "OnAnimatorItemUseCompleteThirdSlot",
                    OnItemUseCompleteThirdSlot);
            }
        }
        ...
        public override int GetItemStateIndex(int slotID)
        {
            ...
            if (m_SlotID == -1)
            {
                if (m_UsableItems[slotID] != null) return m_ItemStateIndex;
            }
        ...
        public override int GetItemSubstateIndex(int slotID)
        {
            if (m_SlotID == -1)
            {
                if (m_UsableItems[slotID] != null) return m_UsableItems[slotID].GetItemSubstateIndex();
            }
            else if (m_SlotID == slotID && m_UsableItems[0] != null)
            {
        ...
        public override bool CanStartAbility()
        {
            ...
            if (m_BlockOverUI && m_PlayerInput != null && m_PlayerInput.IsPointerOverUI()) return false;

            // A look source must exist.
            if (m_LookSource == null) return false;
            ...
            if (m_SlotID == -1)
            {
                for (var i = 0; i < m_UsableItems.Length; ++i)
                {
                    ...
                    {
                        if (m_UseCompleted[i] && !m_CanStopAbility[i] && m_UsableItems[i].IsItemInUse() &&
                            m_UsableItems[i].CanStopItemUse()) m_UsableItems[i].StopItemUse();

                        if (!m_UsableItems[i].CanUseItem(this, UsableItem.UseAbilityState.Start)) continue;
                        canUse = true;
                    }
                }
            }
                ...
                if (item != null)
                {
                    ...
                    if (itemAction != null)
                    {
                        ...
                        if (m_UsableItems[0] != null)
                        {
                            ...
                            if (m_UseCompleted[0] && !m_CanStopAbility[0] && m_UsableItems[0].IsItemInUse() &&
                                m_UsableItems[0].CanStopItemUse()) m_UsableItems[0].StopItemUse();
                            if (m_UsableItems[0].CanUseItem(this, UsableItem.UseAbilityState.Start)) canUse = true;
                        }
                    }
                }
            }
        ...
        public bool UsesItemActionType(Type itemActionType)
        {
            ...
            if (m_SlotID == -1)
            {
                for (var i = 0; i < m_UsableItems.Length; ++i)
                {
                    ...
                    if (itemAction.GetType().IsAssignableFrom(itemActionType)) return true;
                }
            }
            else
            {
        ...
        public override bool ShouldBlockAbilityStart(Ability startingAbility)
        {
            ...
            if (startingAbility is Use && startingAbility != this)
            {
                ...
                for (var i = 0; i < m_UsableItems.Length; ++i)
                {
                    ...
                    for (var j = 0; j < startingUseAbility.UsableItems.Length; ++j)
                    {
                        if (startingUseAbility.UsableItems[j] == null) continue;

                        if (m_UsableItems[i].Item == startingUseAbility.UsableItems[j].Item) return true;
                    }
                }
            }
            ...
            if (startingAbility is Reload)
                ...
                if (startingAbility.InputIndex != -1)
                {
                    ...
                    shouldBlock = true;
                    for (var i = 0; i < reloadAbility.ReloadableItems.Length; ++i)
            ...
            {
                if (m_UsableItems[i] == null) continue;
                if (!m_UsableItems[i].CanStartAbility(startingAbility)) return true;
            }
        ...
        public override bool ShouldStopActiveAbility(Ability activeAbility)
        {
            ...
            if (activeAbility is EquipUnequip) return true;
#if ULTIMATE_CHARACTER_CONTROLLER_SHOOTER
        ...
        private void StopItemReload(Reload reloadAbility)
        {
            for (var i = 0; i < m_UsableItems.Length; ++i)
            {
                ...
                for (var j = 0; j < reloadAbility.ReloadableItems.Length; ++j)
                {
                    if (reloadAbility.ReloadableItems[j] == null) continue;

                    if (m_UsableItems[i].Item == reloadAbility.ReloadableItems[j].Item) reloadAbility.StopItemReload(j);
                }
            }
        }
#endif
        ...
        protected override void AbilityStarted()
        {
            ...
            for (var i = 0; i < m_UsableItems.Length; ++i)
            {
                ...
                if (m_UsableItems[i].ForceRootMotionPosition) m_CharacterLocomotion.ForceRootMotionPosition = true;
                if (m_UsableItems[i].ForceRootMotionRotation) m_CharacterLocomotion.ForceRootMotionRotation = true;
                if (m_UsableItems[i].FaceTarget && !m_CharacterLocomotion.ActiveMovementType.UseIndependentLook(true))
                    FaceTargetItem = m_UsableItems[i].Item;
                ScheduleUseEvent(i);
            ...
            else if (!itemStartedUse)
            {
                ...
                for (var i = 0; i < m_UseCompleted.Length; ++i)
                {
                    if (m_UsableItems[i] == null) continue;
        ...
        private void ScheduleUseEvent(int slotID)
        {
            ...
            if (!m_UsableItems[slotID].UseEvent.WaitForAnimationEvent)
                m_UseEvent[slotID] =
                    SchedulerBase.ScheduleFixed(m_UsableItems[slotID].UseEvent.Duration, UseItem, slotID);
        }
        ...
        {
            if (m_UsableItems[0] == null || !m_UsableItems[0].UseEvent.WaitForSlotEvent ||
                m_UsableItems[0].Item.SlotID != 0) return;
            UseItem(0);
        }
        ...
        private void OnItemUseSecondSlot()
        {
            ...
            if (m_UsableItems[index] == null || !m_UsableItems[index].UseEvent.WaitForSlotEvent ||
                m_UsableItems[index].Item.SlotID != 1) return;
            UseItem(index);
        }
        ...
        private void OnItemUseThirdSlot()
        {
            ...
            if (m_UsableItems[index] == null || !m_UsableItems[index].UseEvent.WaitForSlotEvent ||
                m_UsableItems[index].Item.SlotID != 2) return;
            UseItem(index);
        }
        ...
        /// <summary>
        ///     Updates the ability after the controller has updated. This will ensure the character is in the most up to date
        ///     position.
        /// </summary>
        public override void LateUpdate()
        {
            ...
            for (var i = 0; i < m_UsableItems.Length; ++i)
                if (m_UsableItems[i] != null)
                {
                    ...
                    if (InputIndex != -1 && m_CanStopEvent[i] != null && m_UsableItems[i].CanStopItemUse()) continue;

                    // Don't use the item if the item is waiting for the ItemUse event or has already been used.
                    if (m_WaitForUseEvent[i]) continue;
                    ...
                    if (m_UsableItems[i].CanUseItem(this, UsableItem.UseAbilityState.Update))
                    {
                        ...
                        if (m_UsableItems[i] != null)
                        {
                            ...
                            {
                                ResetCanStopEvent(i);
                                m_CanStopEvent[i] = SchedulerBase.ScheduleFixed(m_UsableItems[i].StopUseAbilityDelay,
                                    AbilityCanStop, i);
                            }
                            else
                            {
                            ...
                            if (!m_UsableItems[i].IsItemUsePending()) ScheduleCompleteEvent(i, true);
                        }
                    }
                }
        ...
        protected void ScheduleCompleteEvent(int index, bool scheduleEvent)
        {
            ...
            if (scheduleEvent)
            {
                ...
                if (!m_UsableItems[index].UseCompleteEvent.WaitForAnimationEvent)
                    m_UseEvent[index] = SchedulerBase.ScheduleFixed(m_UsableItems[index].UseCompleteEvent.Duration,
        ...
        public override void UpdateRotation()
        {
            ...
            if (FaceTargetItem == null) return;

            // The look source may be null if a remote player is still being initialized.
            if (m_LookSource == null || !m_RotateTowardsLookSourceTarget) return;

            // Determine the direction that the character should be facing.
            var lookDirection = m_LookSource.LookDirection(m_LookSource.LookPosition(true), true,
        ...
        {
            if (m_UsableItems[0] == null || !m_UsableItems[0].UseCompleteEvent.WaitForSlotEvent ||
                m_UsableItems[0].Item.SlotID != 0) return;
            UseCompleteItem(0);
        }
        ...
        {
            var index = m_SlotID == -1 ? 1 : 0;
            if (m_UsableItems[index] == null || !m_UsableItems[index].UseCompleteEvent.WaitForSlotEvent ||
                m_UsableItems[index].Item.SlotID != 1) return;
            UseCompleteItem(index);
        }
        ...
        {
            var usableItem = m_UsableItems[slotID];
            if (usableItem == null || !m_WaitForUseCompleteEvent[slotID]) return;
        ...
        public override bool CanStopAbility()
        {
            for (var i = 0; i < m_UsableItems.Length; ++i)
            {
                ...
                if (m_UsableItems[i] != null && m_UsableItems[i].IsItemInUse())
                {
                    ...
                    if (!m_UsableItems[i].CanStopItemUse()) return false;
                    if (!m_UseCompleted[i])
                    {
                        // The complete event may not have been called if the item use was still pending.
                        if (m_UseEvent[i] == null || !m_UseEvent[i].Active) ScheduleCompleteEvent(i, true);
                        return false;
                    }
                }
        ...
        protected override void AbilityStopped(bool force)
        {
            ...
            for (var i = 0; i < m_UsableItems.Length; ++i)
                if (m_UsableItems[i] != null)
                {
                    if (m_UsableItems[i].ForceRootMotionPosition) m_CharacterLocomotion.ForceRootMotionPosition = false;
                    if (m_UsableItems[i].ForceRootMotionRotation) m_CharacterLocomotion.ForceRootMotionRotation = false;
        ...
        {
            if (!(itemAbility is Reload)) return;
            ...
            if (!active && InputIndex != -1 && m_PlayerInput != null)
            {
                ...
                if (startType == AbilityStartType.ButtonDown) m_StartType = AbilityStartType.ButtonDownContinuous;
            ...
            for (var i = 0; i < reloadAbility.ReloadableItems.Length; ++i)
            {
                if (reloadAbility.ReloadableItems[i] == null) continue;
                var slotID = reloadAbility.ReloadableItems[i].Item.SlotID;
                if (m_SlotID != -1)
                {
                    if (m_SlotID != slotID) continue;
                ...
                {
                    m_CanStopEvent[slotID] = SchedulerBase.ScheduleFixed(m_UsableItems[slotID].StopUseAbilityDelay,
                        AbilityCanStop, slotID);
                }
            }
        }
#endif
        ...
        private void OnEnableGameplayInput(bool enable)
        {
            ...
            if (!enable && IsActive) StopAbility(true);
        }
