...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    public class EquipScroll : ItemSetAbilityBase
    {
        ...
        [SerializeField]
        protected float m_ScrollSensitivity = 0.1f;
        ...
        public override void Awake()
        {
            ...
            {
                Debug.LogError(
                    $"Error: The EquipUnequip ItemAbility with the category ID {m_ItemSetCategoryID} must be added to the character.");
                Enabled = false;
            }
        }
        ...
        public override bool CanStartAbility()
        {
            ...
            if (Mathf.Abs(InputAxisValue) < m_ScrollSensitivity) return false;

            m_ScrollItemSetIndex = m_ItemSetManager.NextActiveItemSetIndex(m_ItemSetCategoryIndex,
                m_EquipUnequipItemAbility.ActiveItemSetIndex, InputAxisValue > 0);
