...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class RestrictPosition : Ability
    {
        ...
        [HideInInspector]
        [SerializeField]
        protected float m_MaxXPosition;

        [Tooltip("If restricting the Z axis, specifies the maximum local Z position the character can move to.")]
        [HideInInspector]
        [SerializeField]
        protected float m_MaxZPosition;

        [Tooltip("If restricting the X axis, specifies the minimum local X position the character can move to.")]
        [HideInInspector]
        [SerializeField]
        protected float m_MinXPosition;

        [Tooltip("If restricting the Z axis, specifies the minimum local Z position the character can move to.")]
        [HideInInspector]
        [SerializeField]
        protected float m_MinZPosition;

        [Tooltip("Specifies how to restrict the character's position.")] [HideInInspector] [SerializeField]
        protected RestrictionType m_Restriction = RestrictionType.RestrictXZ;

        public RestrictionType Restiction
        {
            get => m_Restriction;
        ...
        {
            get => m_MinXPosition;
            set => m_MinXPosition = value;
        }

        public float MaxXPosition
        {
            get => m_MaxXPosition;
            set => m_MaxXPosition = value;
        }

        public float MinZPosition
        {
            get => m_MinZPosition;
            set => m_MinZPosition = value;
        }

        public float MaxZPosition
        {
            get => m_MaxZPosition;
            set => m_MaxZPosition = value;
        }
