...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    /// <summary>
    ///     The UltimateCharacterLocomotion component extends the CharacterLocomotion functionality by handling the following
    ///     features:
    ///     - Movement Types
    ///     - Abilities
    ///     - Effects
    ///     - Animator Knowledge
    /// </summary>
    public class UltimateCharacterLocomotion : CharacterLocomotion, ICharacter
    {
        [Tooltip("Specifies the location that the object should be updated.")] [SerializeField]
        protected KinematicObjectManager.UpdateLocation m_UpdateLocation =
        ...
        [SerializeField]
        protected string m_FirstPersonStateName = "FirstPerson";

        [Tooltip("The name of the state that should be activated when the character is in a third person perspective.")]
        [SerializeField]
        protected string m_ThirdPersonStateName = "ThirdPerson";

        [Tooltip("The name of the state that should be activated when the character is moving.")] [SerializeField]
        protected string m_MovingStateName = "Moving";

        [Tooltip("The name of the state that should be activated when the character is airborne.")] [SerializeField]
        protected string m_AirborneStateName = "Airborne";

        [Tooltip("The full name of the active movement type.")] [SerializeField]
        protected string m_MovementTypeFullName;

        [Tooltip("The name of the active first person movement type.")] [SerializeField]
        protected string m_FirstPersonMovementTypeFullName;

        [Tooltip("The name of the active third person movement type.")] [SerializeField]
        protected string m_ThirdPersonMovementTypeFullName;

        [Tooltip("Specifies how much to multiply the yaw parameter by when turning in place.")] [SerializeField]
        protected float m_YawMultiplier = 7;

        [Tooltip("Specifies the value of the Speed Parameter when the character is moving.")] [SerializeField]
        protected float m_MovingSpeedParameterValue = 1;

        [Tooltip("The serialization data for the MovementTypes.")] [SerializeField]
        protected Serialization[] m_MovementTypeData;

        [Tooltip("The serialization data for the Abilities.")] [SerializeField]
        protected Serialization[] m_AbilityData;

        [Tooltip("The serialization data for the Item Abilities.")] [SerializeField]
        protected Serialization[] m_ItemAbilityData;

        [Tooltip("The serialization data for the Effects.")] [SerializeField]
        protected Serialization[] m_EffectData;

        [Tooltip("Unity event invoked when an ability has been started or stopped.")] [SerializeField]
        protected UnityMovementTypeBoolEvent m_OnMovementTypeActiveEvent;

        [Tooltip("Unity event invoked when an movement type has been started or stopped.")] [SerializeField]
        protected UnityAbilityBoolEvent m_OnAbilityActiveEvent;

        [Tooltip("Unity event invoked when an item ability has been started or stopped.")] [SerializeField]
        protected UnityItemAbilityBoolEvent m_OnItemAbilityActiveEvent;

        [Tooltip("Unity event invoked when the character has changed grounded state.")] [SerializeField]
        protected UnityBoolEvent m_OnGroundedEvent;

        [Tooltip("Unity event invoked when the character has landed on the ground.")] [SerializeField]
        protected UnityFloatEvent m_OnLandEvent;

        [Tooltip("Unity event invoked when the time scale has changed.")] [SerializeField]
        protected UnityFloatEvent m_OnChangeTimeScaleEvent;

        [Tooltip("Unity event invoked when the moving platforms have changed.")] [SerializeField]
        protected UnityTransformEvent m_OnChangeMovingPlatformsEvent;

        public string FirstPersonStateName
        {
            get => m_FirstPersonStateName;
            set => m_FirstPersonStateName = value;
        }

        public string ThirdPersonStateName
        {
            get => m_ThirdPersonStateName;
            set => m_ThirdPersonStateName = value;
        }

        public string MovingStateName
        {
            get => m_MovingStateName;
            set => m_MovingStateName = value;
        }

        public string AirborneStateName
        {
            get => m_AirborneStateName;
            set => m_AirborneStateName = value;
        }

        public string MovementTypeFullName
        {
            get => m_MovementTypeFullName;
            set => SetMovementType(value);
        }

        public string FirstPersonMovementTypeFullName
        {
            get => m_FirstPersonMovementTypeFullName;
            set
            {
                if (m_FirstPersonMovementTypeFullName != value)
                {
                    if (!string.IsNullOrEmpty(value) && Application.isPlaying && FirstPersonPerspective)
        ...
        {
            get => m_ThirdPersonMovementTypeFullName;
            set
            {
        ...
        {
            get => m_YawMultiplier;
            set => m_YawMultiplier = value;
        }

        public float MovingSpeedParameterValue
        {
            get => m_MovingSpeedParameterValue;
            set => m_MovingSpeedParameterValue = value;
        }

        public float YawAngle { get; private set; }

        public UnityMovementTypeBoolEvent OnMovementTypeActiveEvent
        {
            get => m_OnMovementTypeActiveEvent;
            set => m_OnMovementTypeActiveEvent = value;
        }

        public UnityAbilityBoolEvent OnAbilityActiveEvent
        {
            get => m_OnAbilityActiveEvent;
            set => m_OnAbilityActiveEvent = value;
        }

        public UnityItemAbilityBoolEvent OnItemAbilityActiveEvent
        {
            get => m_OnItemAbilityActiveEvent;
            set => m_OnItemAbilityActiveEvent = value;
        }

        public UnityBoolEvent OnGroundedEvent
        {
            get => m_OnGroundedEvent;
            set => m_OnGroundedEvent = value;
        }

        public UnityFloatEvent OnLandEvent
        {
            get => m_OnLandEvent;
            set => m_OnLandEvent = value;
        }

        public UnityFloatEvent OnChangeTimeScaleEvent
        {
            get => m_OnChangeTimeScaleEvent;
            set => m_OnChangeTimeScaleEvent = value;
        }

        public UnityTransformEvent OnChangeMovingPlatformsEvent
        {
            get => m_OnChangeMovingPlatformsEvent;
            set => m_OnChangeMovingPlatformsEvent = value;
        }
        ...
        private readonly Dictionary<string, int> m_MovementTypeNameMap = new();
        ...
        {
            get => m_UpdateLocation;
            set
            {
                if (m_UpdateLocation == value) return;
                m_UpdateLocation = value;
                EventHandler.ExecuteEvent(m_GameObject, "OnCharacterChangeUpdateLocation",
                    m_UpdateLocation == KinematicObjectManager.UpdateLocation.FixedUpdate);
            }
        }

        public ILookSource LookSource { get; private set; }
        ...
        public MovementType[] MovementTypes
        {
            ...
            set
            {
                ...
                for (var i = 0; i < m_MovementTypes.Length; ++i)
                    m_MovementTypeNameMap.Add(m_MovementTypes[i].GetType().FullName, i);
            }
        }

        public Serialization[] MovementTypeData
        {
            get => m_MovementTypeData;
            set => m_MovementTypeData = value;
        }
            ...
            set
            {
                ...
                if (Application.isPlaying && m_Abilities != null)
                {
                    if (m_ActiveAbilities == null)
                        ...
                        Array.Resize(ref m_ActiveAbilities, m_Abilities.Length);
        ...
        public Serialization[] AbilityData
        {
            get => m_AbilityData;
            set => m_AbilityData = value;
        }
            ...
            set
            {
                ...
                if (Application.isPlaying && m_ItemAbilities != null)
                {
                    if (m_ActiveItemAbilities == null)
                        ...
                        Array.Resize(ref m_ActiveItemAbilities, m_ItemAbilities.Length);

                    // The ability can be added after the character has already been initialized.
                    for (var i = 0; i < m_ItemAbilities.Length; ++i)
        ...
        public Serialization[] ItemAbilityData
        {
            get => m_ItemAbilityData;
            set => m_ItemAbilityData = value;
        }

        [Snapshot]
        public Ability[] ActiveAbilities
        {
            get => m_ActiveAbilities;
            protected set => m_ActiveAbilities = value;
        }

        [Snapshot]
        public int ActiveAbilityCount
        {
            get => m_ActiveAbilityCount;
            protected set => m_ActiveAbilityCount = value;
        }

        [Snapshot] public bool DirtyAbilityParameter { get; protected set; }

        [Snapshot]
        public ItemAbility[] ActiveItemAbilities
        {
            get => m_ActiveItemAbilities;
            protected set => m_ActiveItemAbilities = value;
        }

        [Snapshot]
        public int ActiveItemAbilityCount
        {
            get => m_ActiveItemAbilityCount;
            protected set => m_ActiveItemAbilityCount = value;
        }

        [Snapshot] public bool DirtyItemAbilityParameter { get; protected set; }

        public Effect[] Effects { get; set; }

        public Serialization[] EffectData
        {
            get => m_EffectData;
            set => m_EffectData = value;
        }

        public MovementType ActiveMovementType { get; private set; }

        public MoveTowards MoveTowardsAbility { get; private set; }

        public ItemEquipVerifier ItemEquipVerifierAbility { get; private set; }
        ...
        public override float TimeScale
        {
            ...
            set
            {
                ...
                if (base.TimeScale != value)
                {
                    ...
                    if (m_OnChangeTimeScaleEvent != null) m_OnChangeTimeScaleEvent.Invoke(value);
                }
        ...
        [Shared.Utility.NonSerialized] public Vector2 RawInputVector { get; set; }
        ...
        {
            get => m_DeltaRotation;
            set => m_DeltaRotation = value;
        }

        [Shared.Utility.NonSerialized]
        public bool Moving
        {
            get => m_Moving || m_InputVector.sqrMagnitude > 0.001f;
            set
            {
                if (m_Moving != value)
                {
        ...
        [Shared.Utility.NonSerialized] public bool SpeedParameterOverride { get; set; }

        [Shared.Utility.NonSerialized] public float SpeedParameterValue => Moving ? m_MovingSpeedParameterValue : 0;
        [Shared.Utility.NonSerialized] public Vector3 AbilityMotor { get; set; }

        [Shared.Utility.NonSerialized] public bool FirstPersonPerspective { get; set; }
        ...
        protected override void Awake()
        {
            ...
            YawAngle = Mathf.Atan2(forwardDirection.x, forwardDirection.z) * Mathf.Rad2Deg;
            Alive = true;
            ...
            {
                m_ActiveAbilities = new Ability[m_Abilities.Length];
                for (var i = 0; i < m_Abilities.Length; ++i) m_Abilities[i].Awake();
            }

            if (m_ItemAbilities != null)
            {
                m_ActiveItemAbilities = new ItemAbility[m_ItemAbilities.Length];
                for (var i = 0; i < m_ItemAbilities.Length; ++i) m_ItemAbilities[i].Awake();
            }

            if (Effects != null)
            {
                m_ActiveEffects = new Effect[Effects.Length];
                for (var i = 0; i < Effects.Length; ++i) Effects[i].Awake();
            }

            // The controller needs to start with a movement type.
            SetMovementType(m_MovementTypeFullName);
            if (ActiveMovementType != null) FirstPersonPerspective = ActiveMovementType.FirstPersonPerspective;
        }
        ...
        public bool DeserializeMovementTypes(bool forceDeserialization)
        {
            ...
            if (m_MovementTypes != null && !forceDeserialization) return false;
            ...
            if (m_MovementTypeData != null && m_MovementTypeData.Length > 0)
            {
                ...
                {
                    m_MovementTypes[i] =
                        m_MovementTypeData[i].DeserializeFields(MemberVisibility.Public) as MovementType;
                    ...
                    m_MovementTypeNameMap.Add(m_MovementTypes[i].GetType().FullName, i);
                    if (Application.isPlaying) m_MovementTypes[i].Initialize(this);
                }
            }
        ...
        public bool DeserializeAbilities(bool forceDeserialization)
        {
            ...
            if (m_Abilities != null && !forceDeserialization) return false;

            var dirty = false;
            if (m_AbilityData != null && m_AbilityData.Length > 0)
            {
                m_Abilities = new Ability[m_AbilityData.Length];
                for (var i = 0; i < m_AbilityData.Length; ++i)
                {
                    ...
                    if (Application.isPlaying) m_Abilities[i].Initialize(this, i);
                    ...
                    if (m_Abilities[i] is MoveTowards)
                        MoveTowardsAbility = m_Abilities[i] as MoveTowards;
                    else if (m_Abilities[i] is ItemEquipVerifier)
                        ItemEquipVerifierAbility = m_Abilities[i] as ItemEquipVerifier;
                }
            }
        ...
        public bool DeserializeItemAbilities(bool forceDeserialization)
        {
            ...
            if (m_ItemAbilityData != null && m_ItemAbilityData.Length > 0)
            {
                ...
                for (var i = 0; i < m_ItemAbilityData.Length; ++i)
                {
                    ...
                    if (Application.isPlaying) m_ItemAbilities[i].Initialize(this, i);
                }
            }
        ...
        public bool DeserializeEffects(bool forceDeserialization)
        {
            ...
            if (Effects != null && !forceDeserialization) return false;

            var dirty = false;
            if (m_EffectData != null && m_EffectData.Length > 0)
            {
                Effects = new Effect[m_EffectData.Length];
                for (var i = 0; i < m_EffectData.Length; ++i)
                {
                    Effects[i] = m_EffectData[i].DeserializeFields(MemberVisibility.Public) as Effect;
                    if (Effects[i] == null)
                    {
                        dirty = true;
                        continue;
                    ...
                    if (Application.isPlaying) Effects[i].Initialize(this, i);
                }
            }
        ...
        /// <summary>
        ///     Returns an array of serialized movement types. Useful for editor scripts when the movement types haven't already
        ///     been deserialized at runtime.
        /// </summary>
        /// <returns>An array of serialized movement types.</returns>
        public MovementType[] GetSerializedMovementTypes()
        {
            if (m_MovementTypeData != null && m_MovementTypeData.Length > 0 &&
                (m_MovementTypes == null || m_MovementTypes.Length == 0)) DeserializeMovementTypes();
            return m_MovementTypes;
        }

        /// <summary>
        ///     Returns an array of serialized abilities. Useful for editor scripts when the abilities haven't already been
        ///     deserialized at runtime.
        /// </summary>
        /// <returns>An array of serialized abilities.</returns>
        public Ability[] GetSerializedAbilities()
        {
            if (m_AbilityData != null && m_AbilityData.Length > 0 && (m_Abilities == null || m_Abilities.Length == 0))
                DeserializeAbilities();
            return m_Abilities;
        }

        /// <summary>
        ///     Returns an array of serialized item abilities. Useful for editor scripts when the item abilities haven't already
        ///     been deserialized at runtime.
        /// </summary>
        ...
        {
            if (m_ItemAbilityData != null && m_ItemAbilityData.Length > 0 &&
                (m_ItemAbilities == null || m_ItemAbilities.Length == 0)) DeserializeItemAbilities();
            return m_ItemAbilities;
        }

        /// <summary>
        ///     Returns an array of serialized effects. Useful for editor scripts when the effects haven't already been
        ///     deserialized at runtime.
        /// </summary>
        /// <returns>An array of serialized effects.</returns>
        public Effect[] GetSerializedEffects()
        {
            if (m_EffectData != null && m_EffectData.Length > 0 && (Effects == null || Effects.Length == 0))
                DeserializeEffects();
            return Effects;
        }
        ...
        {
            SetMovementType(TypeUtility.GetType(typeName));
        }
        ...
        public void SetMovementType(Type type)
        {
            if (type == null || (ActiveMovementType != null && ActiveMovementType.GetType() == type)) return;

            // The MovementTypes may not be deserialized yet.
            if (m_MovementTypeNameMap.Count == 0) DeserializeMovementTypes();
            ...
            if (ActiveMovementType != null && Application.isPlaying)
            {
                ActiveMovementType.ChangeMovementType(false);

                EventHandler.ExecuteEvent(m_GameObject, "OnCharacterChangeMovementType", ActiveMovementType, false);

                if (m_OnMovementTypeActiveEvent != null) m_OnMovementTypeActiveEvent.Invoke(ActiveMovementType, false);
            }

            m_MovementTypeFullName = type.FullName;
            ActiveMovementType = m_MovementTypes[index];

            // Notify the current movement type that is now active.
            if (Application.isPlaying)
            {
                if (ActiveMovementType.FirstPersonPerspective)
                    m_FirstPersonMovementTypeFullName = m_MovementTypeFullName;
                else
                    m_ThirdPersonMovementTypeFullName = m_MovementTypeFullName;
                ActiveMovementType.ChangeMovementType(true);

                EventHandler.ExecuteEvent(m_GameObject, "OnCharacterChangeMovementType", ActiveMovementType, true);

                if (m_OnMovementTypeActiveEvent != null) m_OnMovementTypeActiveEvent.Invoke(ActiveMovementType, true);
            }
        }
        ...
        private void OnAttachLookSource(ILookSource lookSource)
        {
            ...
            if (LookSource != null && KinematicObjectIndex == -1 && enabled)
            {
                var prevIndex = KinematicObjectIndex;
                KinematicObjectIndex = KinematicObjectManager.RegisterCharacter(this);
            ...
            var hasPerspectiveMonitor = m_GameObject.GetComponent<PerspectiveMonitor>() != null;
#else
        ...
        {
            if (LookSource != null && KinematicObjectIndex == -1)
            {
                var prevIndex = KinematicObjectIndex;
        ...
        public override void Start()
        {
            ...
            if (m_TimeScale != 1)
            {
                ...
                if (m_OnChangeTimeScaleEvent != null) m_OnChangeTimeScaleEvent.Invoke(m_TimeScale);
            }
        }

        /// <summary>
        ///     Callback from CharacterLocomotion.Move when the UltimateCharacterLocomotion should perform its updates (such as
        ///     updating the abilities).
        /// </summary>
        protected override void UpdateUltimateLocomotion()
        {
            // The MovementType may change the InputVector.
            RawInputVector = m_InputVector;
            ...
            if (allowPositionalInput)
                ...
                m_InputVector = ActiveMovementType.GetInputVector(m_InputVector);
            else
                m_InputVector = Vector2.zero;
            if (!allowRotationalInput) m_DeltaRotation = Vector3.zero;
            ...
            // Update the effects.
            for (var i = 0; i < m_ActiveEffectCount; ++i) m_ActiveEffects[i].Update();

            // The Moving value is based on the input vector. It does not include vertical movement.
            m_MovingParameter = Moving;
            if (m_Moving != m_InputVector.sqrMagnitude > 0.001f) Moving = !m_Moving;
        }
        ...
        private void AbilitiesAllowInput(out bool allowPositionalInput, out bool allowRotationalInput)
        {
            ...
            for (var i = 0; i < m_ActiveAbilityCount; ++i)
            {
                if (!m_ActiveAbilities[i].AllowPositionalInput) allowPositionalInput = false;
                if (!m_ActiveAbilities[i].AllowRotationalInput) allowRotationalInput = false;
            }

            // If neither the positional or rotational input is allowed then the item abilities don't need to be checked.
            if (!allowPositionalInput && !allowRotationalInput) return;

            // Check the item abilities to see if any disallow input.
            for (var i = 0; i < m_ActiveItemAbilityCount; ++i)
            {
                if (!m_ActiveItemAbilities[i].AllowPositionalInput) allowPositionalInput = false;
                if (!m_ActiveItemAbilities[i].AllowRotationalInput) allowRotationalInput = false;
            }
        }

        /// <summary>
        ///     Try to start an automatic inactive ability and also try to stop an automatic active ability. The Update or
        ///     InactiveUpdate will also be called.
        /// </summary>
            ...
            if (abilities != null)
                for (var i = 0; i < abilities.Length; ++i)
                {
                    if (!abilities[i].IsActive)
                    {
                        ...
                        else if (!(abilities[i] is ItemAbility) &&
                                 abilities[i].StartType != Ability.AbilityStartType.Manual &&
                                 abilities[i].CheckForAbilityMessage &&
                                 (MoveTowardsAbility == null || !MoveTowardsAbility.IsActive))
                            // The ability message can show if the non-automatic/manual ability can start.
                            abilities[i].AbilityMessageCanStart =
                                abilities[i].Enabled && abilities[i].CanStartAbility();
                    }
                    ...
                    if (abilities[i].IsActive)
                        abilities[i].Update();
                    else if (abilities[i].Enabled) abilities[i].InactiveUpdate();
                }
        }
        ...
        protected override void UpdateAnimator()
        {
            ...
            if (m_AnimatorMonitor == null) return;

            for (var i = 0; i < m_ActiveAbilityCount; ++i) m_ActiveAbilities[i].UpdateAnimator();
            for (var i = 0; i < m_ActiveItemAbilityCount; ++i) m_ActiveItemAbilities[i].UpdateAnimator();
            ...
            if (LookSource != null) m_AnimatorMonitor.SetPitchParameter(LookSource.Pitch, m_TimeScale, 0);
            m_AnimatorMonitor.SetYawParameter(YawAngle * m_YawMultiplier, m_TimeScale);
            if (!SpeedParameterOverride) m_AnimatorMonitor.SetSpeedParameter(SpeedParameterValue, m_TimeScale);
        ...
        {
            KinematicObjectManager.BeginCharacterMovement(KinematicObjectIndex);

            base.UpdatePositionAndRotation();
            LateUpdateUltimateLocomotion();

            KinematicObjectManager.EndCharacterMovement(KinematicObjectIndex);
        }
        ...
        protected override bool UpdateGroundState(bool grounded, bool sendEvents)
        {
            ...
            if (groundedStatusChanged)
            {
                ...
                if (sendEvents)
                {
                    ...
                    if (m_OnGroundedEvent != null) m_OnGroundedEvent.Invoke(m_Grounded);
                }
                ...
                if (m_Grounded)
                {
                    ...
                    {
                        var height = m_MaxHeight - m_Transform
                            .InverseTransformDirection(m_Transform.position - m_MaxHeightPosition).y;
                        EventHandler.ExecuteEvent(m_GameObject, "OnCharacterLand", height);
                        if (m_OnLandEvent != null) m_OnLandEvent.Invoke(height);
                    }
                }
                else
                {
        ...
        protected override void UpdateRotation()
        {
            ...
            if (UsingRootMotionRotation) m_DeltaRotation = Vector3.zero;

            // Give the abilities a chance to update the rotation.
            for (var i = 0; i < m_ActiveAbilityCount; ++i) m_ActiveAbilities[i].UpdateRotation();
            for (var i = 0; i < m_ActiveItemAbilityCount; ++i) m_ActiveItemAbilities[i].UpdateRotation();
        ...
        protected override void ApplyRotation()
        {
            ...
            for (var i = 0; i < m_ActiveAbilityCount; ++i) m_ActiveAbilities[i].ApplyRotation();
            for (var i = 0; i < m_ActiveItemAbilityCount; ++i) m_ActiveItemAbilities[i].ApplyRotation();
            ...
            if (m_Platform == null)
            {
                if (Mathf.Abs(m_Torque.eulerAngles.y) > 0.1f)
                    YawAngle = MathUtility.ClampInnerAngle(m_Torque.eulerAngles.y);
            }
            else
            {
                var delta = m_Torque * Quaternion.Inverse(m_PlatformTorque);
                if (Mathf.Abs(delta.eulerAngles.y) > 0.1f) YawAngle = MathUtility.ClampInnerAngle(delta.eulerAngles.y);
            }
        ...
        public override bool SetPlatform(Transform platform, bool platformOverride)
        {
            ...
            if (movingPlatformChanged)
            {
                ...
                if (m_OnChangeMovingPlatformsEvent != null) m_OnChangeMovingPlatformsEvent.Invoke(m_Platform);
            }
        ...
        protected override void UpdatePosition()
        {
            ...
            for (var i = 0; i < m_ActiveAbilityCount; ++i) m_ActiveAbilities[i].UpdatePosition();
            for (var i = 0; i < m_ActiveItemAbilityCount; ++i) m_ActiveItemAbilities[i].UpdatePosition();
        ...
        protected override void ApplyPosition()
        {
            ...
            for (var i = 0; i < m_ActiveAbilityCount; ++i) m_ActiveAbilities[i].ApplyPosition();
            for (var i = 0; i < m_ActiveItemAbilityCount; ++i) m_ActiveItemAbilities[i].ApplyPosition();
        ...
        {
            if (DirtyAbilityParameter) UpdateAbilityAnimatorParameters(true);
            if (DirtyItemAbilityParameter) UpdateItemAbilityAnimatorParameters(true);
        }

        /// <summary>
        ///     Callback after the animator has updated and the character should perform its post movement updates (such as
        ///     updating the item abilities).
        /// </summary>
        ...
        public bool TryStartAbility(Ability ability, bool ignorePriority, bool ignoreCanStartCheck)
        {
            ...
            if (ability is ItemAbility) return TryStartAbility(ability as ItemAbility, ignoreCanStartCheck);

            // Start the ability if it is not active or can be started multiple times, enabled, and can be started.
            if ((!ability.IsActive || ability.CanReceiveMultipleStarts) && ability.Enabled &&
                (ignoreCanStartCheck || ability.CanStartAbility()))
            {
                ...
                if (!ability.IsActive)
                {
                        ...
                        if (!ability.IsConcurrent)
                            for (var i = 0; i < m_ActiveAbilityCount; ++i)
                            {
                                ...
                                if (m_ActiveAbilities[i].IsConcurrent)
                                {
                                    ...
                                    if (((!ignoreLocalPriority && m_ActiveAbilities[i].Index < ability.Index) ||
                                         ignoreLocalPriority) &&
                                        m_ActiveAbilities[i].ShouldBlockAbilityStart(ability)) return false;
                                }
                                else
                                {
                                    ...
                                    if ((m_ActiveAbilities[i].Index < ability.Index && !ignoreLocalPriority) ||
                                        m_ActiveAbilities[i].ShouldBlockAbilityStart(ability))
                                        return false;
                    ...
                    for (var i = m_ActiveAbilityCount - 1; i >= 0; --i)
                        if (ability.ShouldStopActiveAbility(m_ActiveAbilities[i]))
                            TryStopAbility(m_ActiveAbilities[i], true);
                    for (var i = m_ActiveItemAbilityCount - 1; i >= 0; --i)
                    ...
                    if (!(ability is MoveTowards) && MoveTowardsAbility != null)
                        ...
                        if (MoveTowardsAbility.StartMoving(ability.GetMoveTowardsLocations(), ability))
                            moveEquipStarted = true;

                    // The ability may first need to unequip any equipped items before it can start.
                    if (!(ability is ItemEquipVerifier) && ItemEquipVerifierAbility != null)
                        ...
                        if (ItemEquipVerifierAbility.TryToggleItem(ability, true) &&
                            !ability.ImmediateStartItemVerifier)
                            moveEquipStarted = true;

                    // Wait for the MoveTowards and ItemEquipVerifier abilities to end before starting the new ability.
                    if (moveEquipStarted) return true;
                    ...
                    for (var i = m_ActiveAbilityCount; i > index; --i)
                    {
                ...
                if (m_OnAbilityActiveEvent != null) m_OnAbilityActiveEvent.Invoke(ability, true);

                ability.StartAbility(index);
                DirtyAbilityParameter = true;
        ...
        public bool TryStartAbility(ItemAbility itemAbility, bool ignoreCanStartCheck)
        {
            ...
            // Start the ability if it is not active or can be started multiple times, enabled, and can be started.
            if ((!itemAbility.IsActive || itemAbility.CanReceiveMultipleStarts) && itemAbility.Enabled &&
                (ignoreCanStartCheck || itemAbility.CanStartAbility()))
            {
                // The ability cannot be started if the active ability says the current ability cannot be started.
                for (var i = 0; i < m_ActiveItemAbilityCount; ++i)
                ...
                if (!itemAbility.IsActive)
                {
                    ...
                    if (!itemAbility.AbilityWillStart()) return false;
                    ...
                    for (var i = m_ActiveItemAbilityCount; i > index; --i)
                    {
                ...
                if (m_OnItemAbilityActiveEvent != null) m_OnItemAbilityActiveEvent.Invoke(itemAbility, true);

                itemAbility.StartAbility(index);
                DirtyItemAbilityParameter = true;
        ...
        {
            if (m_AnimatorMonitor == null || m_ItemSlotStateIndex == null) return;
            ...
            DirtyItemAbilityParameter = false;

            // Reset the values.
            for (var i = 0; i < m_ItemSlotStateIndex.Length; ++i)
            {
            ...
            int value;
            for (var i = 0; i < m_ActiveItemAbilityCount; ++i)
            for (var j = 0; j < m_ItemSlotSubstateIndex.Length; ++j)
            {
                if (m_ItemSlotStateIndex[j] == -1 && (value = m_ActiveItemAbilities[i].GetItemStateIndex(j)) != -1)
                    m_ItemSlotStateIndex[j] = value;
                if (m_ItemSlotSubstateIndex[j] == -1 &&
                    (value = m_ActiveItemAbilities[i].GetItemSubstateIndex(j)) != -1)
        ...
        public bool TryStopAbility(Ability ability, bool force)
        {
            ...
            if ((!force && !ability.CanStopAbility()) || (force && !ability.CanForceStopAbility())) return false;

            // Update the active ability array by removing the stopped ability.
            if (ability is ItemAbility)
            {
                for (var i = ability.ActiveIndex; i < m_ActiveItemAbilityCount - 1; ++i)
                {
                    m_ActiveItemAbilities[i] = m_ActiveItemAbilities[i + 1];
                    m_ActiveItemAbilities[i].ActiveIndex = i;
                }
                ...
                if (m_OnItemAbilityActiveEvent != null) m_OnItemAbilityActiveEvent.Invoke(itemAbility, false);
                DirtyItemAbilityParameter = true;
            }
            else
            {
                for (var i = ability.ActiveIndex; i < m_ActiveAbilityCount - 1; ++i)
                {
                    m_ActiveAbilities[i] = m_ActiveAbilities[i + 1];
                    m_ActiveAbilities[i].ActiveIndex = i;
                }
                ...
                if (m_OnAbilityActiveEvent != null) m_OnAbilityActiveEvent.Invoke(ability, false);
                DirtyAbilityParameter = true;

                // After the ability has stopped it may need to equip the unequipped items again.
                if (!(ability is ItemEquipVerifier) && !(ability is MoveTowards) && ItemEquipVerifierAbility != null)
                    ItemEquipVerifierAbility.TryToggleItem(ability, false);
            }

            // If the AnimatorMonitor is enabled then the character is dead and the animator parameters should be updated immediately.
            if (m_AnimatorMonitor != null && m_AnimatorMonitor.enabled) UpdateDirtyAbilityAnimatorParameters();
                ...
                if (count > 0)
                {
                    ...
                    for (var i = 0; i < allAbilities.Length; ++i)
                        if (allAbilities[i] is T && (index == -1 || index == allAbilities[i].Index))
                        {
                            ...
                            count++;
                            if (count == abilities.Length) break;
                        }
        ...
        public Ability[] GetAbilities(Type type)
        {
        ...
        /// <param name="index">The index of the ability. -1 will ignore the index.</param>
        /// <returns>The abilities of the specified type with the specified index. Can be null.</returns>
        public Ability[] GetAbilities(Type type, int index)
        {
        ...
        public bool TryStartEffect(Effect effect)
        {
            ...
            if (effect.IsActive || !effect.Enabled || !effect.CanStartEffect()) return false;
        ...
        public bool TryStopEffect(Effect effect)
        {
            ...
            for (var i = index; i < m_ActiveEffectCount - 1; ++i) m_ActiveEffects[i] = m_ActiveEffects[i + 1];
            m_ActiveEffectCount--;
        ...
        {
            if (Effects == null) DeserializeEffects();

            if (Effects != null)
            {
                var type = typeof(T);
                for (var i = 0; i < Effects.Length; ++i)
                    if (type.IsInstanceOfType(Effects[i]) && (index == -1 || index == Effects[i].Index))
        ...
        /// <param name="index">The index of the ability. -1 will ignore the index.</param>
        /// <returns>The effect of the specified type. Can be null.</returns>
        public Effect GetEffect(Type type, int index)
        {
            if (type == null) return null;
            if (Effects == null) DeserializeEffects();
        ...
        protected override void OnAnimatorMove()
        {
            ...
            {
                for (var i = 0; i < m_ActiveAbilityCount; ++i) m_ActiveAbilities[i].OnAnimatorMove(true);
                for (var i = 0; i < m_ActiveItemAbilityCount; ++i) m_ActiveItemAbilities[i].OnAnimatorMove(true);
            }
            ...
            {
                for (var i = 0; i < m_ActiveAbilityCount; ++i) m_ActiveAbilities[i].OnAnimatorMove(false);
                for (var i = 0; i < m_ActiveItemAbilityCount; ++i) m_ActiveItemAbilities[i].OnAnimatorMove(false);
            }
        ...
        private void OnChangePerspectives(bool firstPersonPerspective)
        {
            ...
            if (ActiveMovementType == null) SetMovementType(m_MovementTypeFullName);
        }
        ...
        public void SetRotation(Quaternion rotation, bool snapAnimator)
        {
            ...
            if (snapAnimator) StopAllAbilities(false);

            // If the index is -1 then the character isn't registered with the Kinematic Object Manager.
            if (KinematicObjectIndex != -1)
            {
                KinematicObjectManager.SetCharacterRotation(KinematicObjectIndex, rotation);
        ...
        public void SetPosition(Vector3 position, bool snapAnimator)
        {
            ...
            if (KinematicObjectIndex != -1)
            {
                KinematicObjectManager.SetCharacterPosition(KinematicObjectIndex, position);
        ...
        public override void ResetRotationPosition()
        {
            ...
            KinematicObjectManager.SetCharacterRotation(KinematicObjectIndex, m_Transform.rotation);
            KinematicObjectManager.SetCharacterPosition(KinematicObjectIndex, m_Transform.position);
            ...
            bool stopAllAbilities)
        {
            ...
            if (stopAllAbilities) StopAllAbilities(false);
        ...
        [Obsolete("SetActive has been deprecated. Use GameObject.SetActive instead.")]
        ...
        /// <summary>
        ///     Casts a ray using in the specified direction. If the character has multiple colliders added then a ray will be cast
        ///     from each collider.
            ...
            for (var i = 0; i < m_ColliderCount; ++i)
                ...
                if (m_Colliders[i] is CapsuleCollider)
                {
                    ...
                    var radius = capsuleCollider.radius * MathUtility.ColliderRadiusMultiplier(capsuleCollider) -
                                 ColliderSpacing;
                    if (Physics.CapsuleCast(startEndCap + offset, endEndCap + offset, radius, direction.normalized,
                ...
                else
                {
                    ...
                    var radius = sphereCollider.radius * MathUtility.ColliderRadiusMultiplier(sphereCollider) -
                                 ColliderSpacing;
                    if (Physics.SphereCast(sphereCollider.transform.TransformPoint(sphereCollider.center) + offset,
        ...
        public int Cast(Vector3 direction, Vector3 offset, ref RaycastHit[] combinedRaycastHits,
            ref Dictionary<RaycastHit, int> colliderIndexMap)
        {
            ...
            for (var i = 0; i < m_ColliderCount; ++i)
            {
                ...
                if (m_Colliders[i] is CapsuleCollider)
                {
                    ...
                    localHitCount = Physics.CapsuleCastNonAlloc(startEndCap, endEndCap, radius, direction.normalized,
                        m_RaycastHits, direction.magnitude + ColliderSpacing, m_CharacterLayerManager.SolidObjectLayers,
                ...
                if (localHitCount > 0)
                {
                    ...
                    if (m_ColliderCount > 1)
                    {
                        ...
                        {
                            if (colliderIndexMap.ContainsKey(m_RaycastHits[j])) continue;
        ...
        {
            var count = 0;
            for (var i = 0; i < m_ColliderCount; ++i) count += OverlapCount(m_Colliders[i], offset);
            return count;
        }
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (m_Abilities != null)
                for (var i = 0; i < m_Abilities.Length; ++i)
                {
                    if (!m_Abilities[i].Enabled) continue;
            ...
            if (m_ItemAbilities != null)
                for (var i = 0; i < m_ItemAbilities.Length; ++i)
                {
                    if (!m_ItemAbilities[i].Enabled) continue;
        ...
        private void OnDeath(Vector3 position, Vector3 force, GameObject attacker)
        {
            ...
            KinematicObjectManager.SetCharacterMovementInput(KinematicObjectIndex, 0, 0);
            KinematicObjectManager.SetCharacterDeltaYawRotation(KinematicObjectIndex, 0);
        }
        ...
        private void StopAllAbilities(bool fromDeath)
        {
            for (var i = m_ActiveAbilityCount - 1; i >= 0; --i)
            {
                ...
                if (m_ActiveAbilities[i] == null) continue;
            ...
            {
                // Another ability may have already stopped the active ability.
                if (m_ActiveItemAbilities[i] == null) continue;
        ...
        private void OnRespawn()
        {
            ...
            {
                if (LookSource != null) m_AnimatorMonitor.SetPitchParameter(LookSource.Pitch, 1, 0);
                m_AnimatorMonitor.SetYawParameter(YawAngle, 1, 0);
        ...
        private void OnImmediateTransformChange(bool snapAnimator)
        {
            ...
            if (snapAnimator) EventHandler.ExecuteEvent(m_GameObject, "OnCharacterSnapAnimator");
        }
        ...
        private void OnDisable()
        {
            ...
            // The KinematicObjectManager is responsible for calling the move method.
            KinematicObjectManager.UnregisterCharacter(KinematicObjectIndex);
        ...
        private void OnDestroy()
        {
            ...
            if (ActiveMovementType != null) ActiveMovementType.ChangeMovementType(false);
