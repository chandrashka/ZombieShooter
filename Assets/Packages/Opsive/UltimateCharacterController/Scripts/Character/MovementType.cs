...
{
    /// <summary>
    ///     MovementType is an abstract class which tells the character controller how to move and rotate. This allows for
    ///     different movement types such as combat and adventure.
    /// </summary>
    [Preserve]
    public abstract class MovementType : StateObject
    {
        ...
        public abstract float GetDeltaYawRotation(float characterHorizontalMovement, float characterForwardMovement,
        ...
        public virtual bool UseIndependentLook(bool characterLookDirection)
        {
            return m_ForceIndependentLook;
        }
