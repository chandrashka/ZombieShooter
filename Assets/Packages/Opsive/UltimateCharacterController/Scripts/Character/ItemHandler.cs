...
namespace Opsive.UltimateCharacterController.Character
{
    ...
    public class ItemHandler : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            EventHandler.RegisterEvent<Item, int>(gameObject, "OnInventoryEquipItem", OnEquipItem);
        }
        ...
        private void Update()
        {
            ...
            for (var i = 0; i < m_Inventory.SlotCount; ++i)
            {
                ...
                if (item != null && item.IsActive() && item.DominantItem) item.Move(lookVector.x, lookVector.y);
            }
        ...
        {
            EventHandler.UnregisterEvent<Item, int>(gameObject, "OnInventoryEquipItem", OnEquipItem);
        }
