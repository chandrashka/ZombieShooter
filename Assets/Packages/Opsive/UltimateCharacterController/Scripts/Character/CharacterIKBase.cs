...
{
    /// <summary>
    ///     Base class for applying IK on the character. Allows other IK solutions to easily be used instead of Unity's IK
    ///     system.
    /// </summary>
    public abstract class CharacterIKBase : StateBehavior
    {
        ...
        public Func<IKGoal, Vector3, Quaternion, Vector3> OnUpdateIKPosition
        {
            get => m_OnUpdateIKPosition;
            set => m_OnUpdateIKPosition = value;
        }

        public Func<IKGoal, Quaternion, Vector3, Quaternion> OnUpdateIKRotation
        {
            get => m_OnUpdateIKRotation;
            set => m_OnUpdateIKRotation = value;
        }
        ...
        public abstract void SetItemIKTargets(Transform itemTransform, Transform itemHand,
