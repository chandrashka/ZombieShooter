...
namespace Opsive.UltimateCharacterController.Inventory
{
    ...
    {
        [Tooltip("Should all of the IItemIdentifier be removed when the character dies?")] [SerializeField]
        protected bool m_RemoveAllOnDeath = true;

        [Tooltip("Should the default loadout be loaded when the character respawns?")] [SerializeField]
        protected bool m_LoadDefaultLoadoutOnRespawn = true;

        [Tooltip("The name of the state when the inventory is unequipped.")] [SerializeField]
        protected string m_UnequippedStateName = "Unequipped";

        [Tooltip("Unity event that is invoked when an item is initially added to the inventory.")] [SerializeField]
        protected UnityItemEvent m_OnAddItemEvent;

        [Tooltip("Unity event that is invoked when an IItemIdentifier is picked up.")] [SerializeField]
        protected UnityItemIdentifierFloatBoolBoolEvent m_OnPickupItemIdentifierEvent;

        [Tooltip("Unity event that is invoked when an item is picked up.")] [SerializeField]
        protected UnityItemFloatBoolBoolEvent m_OnPickupItemEvent;

        [Tooltip("Unity event that is invoked when an item is equipped.")] [SerializeField]
        protected UnityItemIntEvent m_OnEquipItemEvent;

        [Tooltip("Unity event that is invoked when an IItemIdentifier is adjusted.")] [SerializeField]
        protected UnityItemIdentifierFloatEvent m_OnAdjustItemIdentifierAmountEvent;

        [Tooltip("Unity event that is invoked when an item is unequipped.")] [SerializeField]
        protected UnityItemIntEvent m_OnUnequipItemEvent;

        [Tooltip("Unity event that is invoked when an item is removed.")] [SerializeField]
        protected UnityItemIntEvent m_OnRemoveItemEvent;

        public bool RemoveAllOnDeath
        {
            get => m_RemoveAllOnDeath;
            set => m_RemoveAllOnDeath = value;
        }

        public bool LoadDefaultLoadoutOnRespawn
        {
            get => m_LoadDefaultLoadoutOnRespawn;
            set => m_LoadDefaultLoadoutOnRespawn = value;
        }

        public string UnequippedStateName
        {
            get => m_UnequippedStateName;
            set => m_UnequippedStateName = value;
        }

        public UnityItemEvent OnAddItemEvent
        {
            get => m_OnAddItemEvent;
            set => m_OnAddItemEvent = value;
        }

        public UnityItemIdentifierFloatBoolBoolEvent OnPickupItemIdentifierEvent
        {
            get => m_OnPickupItemIdentifierEvent;
            set => m_OnPickupItemIdentifierEvent = value;
        }

        public UnityItemFloatBoolBoolEvent OnPickupItemEvent
        {
            get => m_OnPickupItemEvent;
            set => m_OnPickupItemEvent = value;
        }

        public UnityItemIntEvent OnEquipItemEvent
        {
            get => m_OnEquipItemEvent;
            set => m_OnEquipItemEvent = value;
        }

        public UnityItemIdentifierFloatEvent OnAdjustItemIdentifierAmountEvent
        {
            get => m_OnAdjustItemIdentifierAmountEvent;
            set => m_OnAdjustItemIdentifierAmountEvent = value;
        }

        public UnityItemIntEvent OnUnequipItemEvent
        {
            get => m_OnUnequipItemEvent;
            set => m_OnUnequipItemEvent = value;
        }

        public UnityItemIntEvent OnRemoveItemEvent
        {
            get => m_OnRemoveItemEvent;
            set => m_OnRemoveItemEvent = value;
        }
        ...
        protected List<Item> m_AllItems = new();
        protected List<IItemIdentifier> m_AllItemIdentifiers = new();
        ...
        public void AddItem(Item item, bool immediateEquip, bool forceEquip)
        {
            if (AddItemInternal(item))
            {
                ...
                if (m_OnAddItemEvent != null) m_OnAddItemEvent.Invoke(item);
        ...
        /// <summary>
        ///     Internal method which adds the item to the Inventory. This does not add the actual IItemIdentifier - PickupItem
        ///     does that.
        /// </summary>
        /// <param name="item">The item to add.</param>
        ...
        public bool Pickup(IItemIdentifier itemIdentifier, int amount, int slotID, bool immediatePickup,
            bool forceEquip)
        {
        ...
        /// <returns>True if the ItemIdentifier was picked up.</returns>
        public bool Pickup(IItemIdentifier itemIdentifier, int amount, int slotID, bool immediatePickup,
            bool forceEquip, bool notifyOnPickup)
        {
            // Prevent pickup when the inventory isn't enabled.
            if (itemIdentifier == null || !enabled || amount == 0) return false;
            ...
            if (pickedUp && notifyOnPickup)
            {
                ...
                if (slotID != -1)
                {
                    ...
                    if (item != null && !m_AllItems.Contains(item)) m_AllItems.Add(item);
                }
            }
        ...
        /// <param name="forceEquip">Should the item be force equipped?</param>
        protected void ItemIdentifierPickedUp(IItemIdentifier itemIdentifier, int amount, int slotID,
            bool immediatePickup, bool forceEquip)
        {
            ...
            EventHandler.ExecuteEvent(m_GameObject, "OnInventoryPickupItemIdentifier", itemIdentifier, amount,
            ...
            if (slotID != -1)
            {
                ...
                if (item != null)
                {
                    ...
                    EventHandler.ExecuteEvent(m_GameObject, "OnInventoryPickupItem", item, amount, immediatePickup,
                        forceEquip);
            ...
            if (!m_AllItemIdentifiers.Contains(itemIdentifier)) m_AllItemIdentifiers.Add(itemIdentifier);
        }
        ...
        public Item GetActiveItem(int slotID)
        {
            return GetActiveItemInternal(slotID);
        }
        ...
        public Item GetItem(IItemIdentifier itemIdentifier, int slotID)
        {
            return GetItemInternal(itemIdentifier, slotID);
        }
        ...
        public List<IItemIdentifier> GetAllItemIdentifiers()
        {
            return m_AllItemIdentifiers;
        }
        ...
        public void EquipItem(IItemIdentifier itemIdentifier, int slotID, bool immediateEquip)
        {
            ...
            if (currentItem != null && currentItem.ItemIdentifier != itemIdentifier) UnequipItem(slotID);
            ...
            if (item != null)
            {
                ...
                if (m_OnEquipItemEvent != null) m_OnEquipItemEvent.Invoke(item, slotID);
        ...
        ///     The ItemIdentifier to unequip. If the ItemIdentifier isn't currently equipped then no
        ...
        public void UnequipItem(IItemIdentifier itemIdentifier, int slotID)
        {
            ...
            var currentItem = GetActiveItem(slotID);
            if (currentItem == null || currentItem.ItemIdentifier != itemIdentifier) return;
        ...
        public void UnequipItem(int slotID)
        {
            ...
            if (item != null)
            {
                ...
                if (m_OnUnequipItemEvent != null) m_OnUnequipItemEvent.Invoke(item, slotID);
                ...
                if (!string.IsNullOrEmpty(m_UnequippedStateName))
                {
                    ...
                    for (var i = 0; i < m_SlotCount; ++i)
                    {
                        ...
                        if (GetActiveItem(i) != null) unequipped = false;
                    }

                    if (unequipped) StateManager.SetState(m_GameObject, m_UnequippedStateName, true);
                }
            }
        }
        ...
        public int GetItemIdentifierAmount(IItemIdentifier itemIdentifier)
        {
            if (itemIdentifier == null) return 0;
            return GetItemIdentifierAmountInternal(itemIdentifier);
        }
        ...
        {
            if (itemIdentifier == null || amount == 0) return;
        ...
        public virtual void RemoveItem(IItemIdentifier itemIdentifier, int slotID, int amount, bool drop)
        {
            ...
            if (item != null)
            {
                ...
                if (drop) item.Drop(amount, false, false);
                ...
                if (item.DropConsumableItems)
                {
                    ...
                    if (itemActions != null)
                    {
                        ...
                        for (var i = 0; i < itemActions.Length; ++i)
                            if ((usableItem = itemActions[i] as IUsableItem) != null &&
                                (consumableItemIdentifier = usableItem.GetConsumableItemIdentifier()) != null)
                            {
            ...
            if (GetItemIdentifierAmount(itemIdentifier) == 0) m_AllItemIdentifiers.Remove(itemIdentifier);
            ...
            if (item != null)
            {
                ...
                if (m_OnRemoveItemEvent != null) m_OnRemoveItemEvent.Invoke(item, slotID);
            }
        ...
        public virtual GameObject DropItem(Item item, int amount, bool forceDrop, bool remove)
        {
            ...
            if (item.DropPrefab != null)
            {
                ...
                if (existingAmount > 0)
                    ...
                    for (var i = 0; i < item.ItemActions.Length; ++i)
                    {
                        var usableItem = item.ItemActions[i] as UsableItem;
                        if (usableItem != null && usableItem.GetConsumableItemIdentifier() != null &&
                            !usableItem.CanEquipEmptyItem &&
                            GetItemIdentifierAmount(usableItem.GetConsumableItemIdentifier()) == 0)
                        {
                            existingAmount = 0;
                            break;
                        }
                ...
                if (existingAmount > 0 || forceDrop)
                {
                    ...
                    if (itemPickup != null)
                    {
                        ...
                        var itemDefinitionAmount = new ItemDefinitionAmount(item.ItemIdentifier.GetItemDefinition(),
                            Mathf.Min(existingAmount, amount));
                        ...
                        if (item.DropConsumableItems)
                            for (var i = 0; i < item.ItemActions.Length; ++i)
                                if ((usableItem = item.ItemActions[i] as UsableItem) != null &&
                                    usableItem.GetConsumableItemIdentifier() != null &&
                        ...
                        if (item.DropConsumableItems)
                        {
                            ...
                            for (var i = 0; i < item.ItemActions.Length; ++i)
                                    ...
                                    usableItem.GetConsumableItemIdentifierAmount() != -1)
                                {
                                    ...
                                    var remainingConsumableAmount =
                                        usableItem
                                            .GetConsumableItemIdentifierAmount(); // The count may be negative (for use by the UI).
                                    var consumableDefinitionAmount = new ItemDefinitionAmount(
                                        consumableItemIdentifier.GetItemDefinition(),
                                        consumableDropCount +
                                        (remainingConsumableAmount > 0 ? remainingConsumableAmount : 0));
                    ...
                    var trajectoryObject = spawnedObject.GetCachedComponent<TrajectoryObject>();
...
#endif
                        trajectoryObject.Initialize(velocity, item.CharacterLocomotion.Torque.eulerAngles,
                            item.Character);
                    }
#if ULTIMATE_CHARACTER_CONTROLLER_MULTIPLAYER
            ...
            if (item.DropItemEvent != null) item.DropItemEvent.Invoke();
        ...
        protected void SendItemIdentifierAdjustmentEvents(IItemIdentifier itemIdentifier)
        {
            ...
            if (amount == 0) m_AllItemIdentifiers.Remove(itemIdentifier);
        }
        ...
        public virtual void RemoveAllItems(bool drop)
        {
            ...
            for (var i = allItems.Count - 1; i >= 0; --i)
            {
                ...
                if (allItems.Count <= i) continue;
                var itemIdentifier = allItems[i].ItemIdentifier;
                var slotID = allItems[i].SlotID;
                while (GetItemIdentifierAmount(itemIdentifier) > 0) RemoveItem(itemIdentifier, slotID, 1, drop);
            }
        }
        ...
        {
            enabled = true;
            if (m_LoadDefaultLoadoutOnRespawn) LoadDefaultLoadout();
