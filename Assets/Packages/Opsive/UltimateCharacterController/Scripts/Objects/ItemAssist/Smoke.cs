    ...
    public class Smoke : MonoBehaviour
    {
        ...
        public void Show(Item item, int itemActionID, UltimateCharacterLocomotion characterLocomotion)
        {
            ...
            for (var i = 0; i < m_Particles.Length; ++i)
            {
                m_Particles[i].Play();
                var lifeTime = 0f;
                if ((lifeTime = m_Particles[i].main.startLifetime.Evaluate(0)) > maxLifeTime) maxLifeTime = lifeTime;
            }
        ...
        private void OnChangePerspectives(bool firstPersonPerspective)
        {
            ...
            var perspectiveProperties = firstPersonPerspective
                ? itemAction.FirstPersonPerspectiveProperties
                : itemAction.ThirdPersonPerspectiveProperties;
