...
namespace Opsive.UltimateCharacterController.Objects.ItemAssist
{
    ...
    /// <summary>
    ///     The ParticleProjectile extends Projectile and notifies the MagicItem when the object has collided with another
    ///     object.
    ...
    public class MagicProjectile : Projectile
    {
        ...
        public virtual void Initialize(Vector3 velocity, Vector3 torque, GameObject originator, MagicItem magicItem,
            uint castID)
        {
            m_MagicItem = magicItem;
            m_CastID = castID;

            Initialize(velocity, torque, m_DamageProcessor, m_DamageAmount, m_ImpactForce, m_ImpactForceFrames,
                m_ImpactLayers, m_ImpactStateName, m_ImpactStateDisableTimer, m_SurfaceImpact, originator);
