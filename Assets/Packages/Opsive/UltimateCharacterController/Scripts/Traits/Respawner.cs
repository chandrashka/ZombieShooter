...
namespace Opsive.UltimateCharacterController.Traits
{
    ...
    public class Respawner : StateBehavior
    {
        ...
        [Tooltip("Specifies the location the object should spawn.")] [SerializeField]
        protected SpawnPositioningMode m_PositioningMode = SpawnPositioningMode.StartLocation;
        ...
        [SerializeField]
        protected float m_MinRespawnTime = 2;

        [Tooltip("The maximum amount of time before the object respawns after death or after being disabled.")]
        [SerializeField]
        protected float m_MaxRespawnTime = 3;

        [Tooltip("Should a respawn be scheduled when the object dies?")] [SerializeField]
        protected bool m_ScheduleRespawnOnDeath = true;

        [Tooltip("Should a respawn be scheduled when the component is disabled?")] [SerializeField]
        protected bool m_ScheduleRespawnOnDisable = true;

        [Tooltip("A set of AudioClips that can be played when the object is respawned.")]
        [HideInInspector]
        [SerializeField]
        protected AudioClipSet m_RespawnAudioClipSet = new();

        [Tooltip("Unity event invoked when the object respawns.")] [SerializeField]
        protected UnityEvent m_OnRespawnEvent;

        public SpawnPositioningMode PositioningMode
        {
            get => m_PositioningMode;
        ...
        {
            if (!m_ScheduleRespawnOnDeath) return;
        ...
        protected virtual void OnDisable()
        {
            ...
            if (ScheduleRespawnOnDisable && m_ScheduledRespawnEvent == null)
                m_ScheduledRespawnEvent =
                    SchedulerBase.Schedule(Random.Range(m_MinRespawnTime, m_MaxRespawnTime), Respawn);
        }
        ...
        public virtual void Respawn(Vector3 position, Quaternion rotation, bool transformChange)
        {
            ...
            if (m_OnRespawnEvent != null) m_OnRespawnEvent.Invoke();
