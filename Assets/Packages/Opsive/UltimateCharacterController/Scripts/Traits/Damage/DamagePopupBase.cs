...
namespace Opsive.UltimateCharacterController.Traits.Damage
{
    ...
    {
        [Tooltip("The lifetime before being returned to the pool.")] [SerializeField]
        protected float m_DefaultLifeTime = 1;

        [Tooltip("The ofset of the popup relative to the damage position.")] [SerializeField]
        protected Vector3 m_Offset = new(0, 1, 0);

        [Tooltip("The string format of the displayed damage amount.")] [SerializeField]
        protected string m_Format = "#.##";

        [Tooltip("A reference to the Animator which shows the popup. This can be null.")] [SerializeField]
        protected Animator m_Animator;

        [Tooltip("A reference to the Animator which shows the popup. This can be null.")] [SerializeField]
        protected string m_OpenAnimationName = "Open";
        ...
        public void Open()
        {
            if (m_Camera == null) m_Camera = UnityEngine.Camera.main;
