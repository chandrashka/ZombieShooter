...
namespace Opsive.UltimateCharacterController.Traits.Damage
{
    ...
    public class DamageData
    {
        ...
        public virtual void SetDamage(float amount, Vector3 position, Vector3 direction, float forceMagnitude,
            int frames, float radius, GameObject attacker, object attackerObject, Collider hitCollider)
        {
            m_DamageOriginator = new DefaultDamageOriginator
            {
                Owner = attacker,
                OriginatingGameObject = attackerObject as MonoBehaviour != null
        ...
        public virtual void SetDamage(IDamageOriginator damageOriginator, float amount, Vector3 position,
            Vector3 direction, float forceMagnitude, int frames, float radius, Collider hitCollider)
        {
    ...
    public class DamageProcessor : ScriptableObject
    {
        ...
        public static DamageProcessor Default
        {
            get
            {
                if (m_Default == null) m_Default = CreateInstance<DamageProcessor>();
    ...
    public static class DamageUtility
    {
        ...
        public static IDamageTarget GetDamageTarget(GameObject gameObject)
        {
            ...
            if (damageTarget != null) return damageTarget;
