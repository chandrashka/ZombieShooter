...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items.AnimatorAudioState
{
    ...
    public static class AnimatorAudioStateSetInspector
    {
        ...
        /// </summary>
        public static void DrawAnimatorAudioStateSet(Object target, AnimatorAudioStateSet animatorAudioStateSet,
            string animatorAudioStateSetFieldName, bool randomDefaultSelector,
            ref ReorderableList reorderableList, ReorderableList.ElementCallbackDelegate drawCallback,
            ...
            ReorderableList.AddCallbackDelegate addAudioCallback,
            ReorderableList.RemoveCallbackDelegate removeAudioCallback,
            ref ReorderableList reorderableStateList, ReorderableList.ElementCallbackDelegate stateDrawElementCallback,
            ReorderableList.AddCallbackDelegate stateAddCallback,
            ReorderableList.ReorderCallbackDelegate stateReorderCallback,
            ReorderableList.RemoveCallbackDelegate stateRemoveCallback, string statePreferencesKey)
        {
            ...
            if (s_SelectorTypeNameCache != null)
            {
                ...
                if (animatorAudioStateSet.AnimatorAudioStateSelectorData != null &&
                    !string.IsNullOrEmpty(animatorAudioStateSet.AnimatorAudioStateSelectorData.ObjectType))
                    for (var i = 0; i < s_SelectorTypeCache.Count; ++i)
                        if (s_SelectorTypeCache[i].FullName ==
                            animatorAudioStateSet.AnimatorAudioStateSelectorData.ObjectType)
                        {
                            selected = i;
                            forceUpdate = false;
                            break;
                ...
                if (newSelected != selected || forceUpdate)
                {
                    ...
                    if (forceUpdate)
                        for (var i = 0; i < s_SelectorTypeCache.Count; ++i)
                            if ((randomDefaultSelector && s_SelectorTypeCache[i].FullName ==
                                    "Opsive.UltimateCharacterController.Items.AnimatorAudioStates.Sequence") ||
                                (!randomDefaultSelector && s_SelectorTypeCache[i].FullName ==
                                    "Opsive.UltimateCharacterController.Items.AnimatorAudioStates.ConstantRecoil"))
                            {
                                newSelected = i;
                                break;
                            }

                    var animatorAudioOutputSelector =
                        Activator.CreateInstance(s_SelectorTypeCache[newSelected]) as AnimatorAudioStateSelector;
                    animatorAudioStateSet.AnimatorAudioStateSelectorData =
                        Serialization.Serialize(animatorAudioOutputSelector);
            ...
            if (animatorAudioStateSet.AnimatorAudioStateSelector != null)
            {
                ...
                InspectorUtility.DrawObject(animatorAudioStateSet.AnimatorAudioStateSelector, false, true, target,
                    false, () =>
                    {
                        animatorAudioStateSet.AnimatorAudioStateSelectorData =
                            Serialization.Serialize(animatorAudioStateSet.AnimatorAudioStateSelector);
                        EditorUtility.SetDirty(target);
                    });
                EditorGUI.indentLevel--;
            }
            ...
            if (animatorAudioStateSet.States == null || animatorAudioStateSet.States.Length == 0)
                animatorAudioStateSet.States = new AnimatorAudioStateSet.AnimatorAudioState[] { new() };

            var serializedObject = new SerializedObject(target);
            var serializedProperty = serializedObject.FindProperty(animatorAudioStateSetFieldName)
                .FindPropertyRelative("m_States");
            if (reorderableList == null)
            {
                reorderableList = new ReorderableList(animatorAudioStateSet.States,
                    typeof(AnimatorAudioStateSet.AnimatorAudioState), false, true, true,
                    animatorAudioStateSet.States.Length > 1);
            ...
            reorderableAudioList = AudioClipSetInspector.DrawAudioClipSet(animatorAudioState.AudioClipSet,
                reorderableAudioList, drawAudioElementCallback, addAudioCallback, removeAudioCallback);
            if (Shared.Editor.Inspectors.Utility.InspectorUtility.Foldout(animatorAudioState, new GUIContent("States"),
                    false))
            {
                EditorGUI.indentLevel--;
                ...
                try
                {
                    ...
                    reorderableStateList = StateInspector.DrawStates(reorderableStateList, new SerializedObject(target),
        ...
        {
            if (s_SelectorTypeCache != null) return;
            ...
            for (var i = 0; i < assemblies.Length; ++i)
            {
                ...
                for (var j = 0; j < assemblyTypes.Length; ++j)
                {
                    ...
                    if (!typeof(AnimatorAudioStateSelector).IsAssignableFrom(assemblyTypes[j])) continue;
        ...
        /// </summary>
        public static void OnAnimatorAudioStateElementDraw(ReorderableList list,
            AnimatorAudioStateSet animatorAudioStateSet, Rect rect, int index, bool isActive, bool isFocused,
            Object target)
        {
            ...
            {
                list.serializedProperty.GetArrayElementAtIndex(index).FindPropertyRelative("m_Enabled").boolValue =
                    EditorGUI.Toggle(activeRect, animatorAudioStateSet.States[index].Enabled);
                list.serializedProperty.serializedObject.ApplyModifiedProperties();
            }
            else
            {
                animatorAudioStateSet.States[index].Enabled =
                    EditorGUI.Toggle(activeRect, animatorAudioStateSet.States[index].Enabled);
            }

            if (EditorGUI.EndChangeCheck()) EditorUtility.RecordUndoDirtyObject(target, "Change Value");
        }
        ...
        /// </summary>
        public static void OnAnimatorAudioStateListAdd(ReorderableList list,
            AnimatorAudioStateSet animatorAudioStateSet, string preferencesKey)
        {
            // Add a new state.
        ...
        /// </summary>
        public static void OnAnimatorAudioStateListRemove(ReorderableList list,
            AnimatorAudioStateSet animatorAudioStateSet, string preferencesKey)
        {
        ...
        /// </summary>
        public static void OnAudioClipDraw(ReorderableList list, Rect rect, int index,
            AnimatorAudioStateSet.AnimatorAudioState[] animatorAudioStates, string preferencesKey, Object target)
        {
        ...
        /// </summary>
        public static void OnAudioClipListAdd(ReorderableList list,
            AnimatorAudioStateSet.AnimatorAudioState[] animatorAudioStates, string preferencesKey, Object target)
        {
            var state = animatorAudioStates[EditorPrefs.GetInt(preferencesKey, 0)];
        ...
        /// </summary>
        public static void OnAudioClipListRemove(ReorderableList list,
            AnimatorAudioStateSet.AnimatorAudioState[] animatorAudioStates, string preferencesKey, Object target)
        {
            var state = animatorAudioStates[EditorPrefs.GetInt(preferencesKey, 0)];
