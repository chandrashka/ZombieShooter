...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items.Actions
{
    ...
    {
        private const string c_EditorPrefsSelectedRecoilAnimatorAudioStateSetIndexKey =
            "Opsive.UltimateCharacterController.Editor.Inspectors.SelectedRecoilAnimatorAudioStateSetIndex";

        private const string c_EditorPrefsSelectedRecoilAnimatorAudioStateSetStateIndexKey =
            "Opsive.UltimateCharacterController.Editor.Inspectors.SelectedRecoilAnimatorAudioStateSetStateIndex";
        ...
        private string SelectedRecoilAnimatorAudioStateSetIndexKey =>
            c_EditorPrefsSelectedRecoilAnimatorAudioStateSetIndexKey + "." + target.GetType() + "." + target.name;
        ...
        protected override void OnEnable()
        {
            ...
            if (m_MeleeWeapon == null) return;
            var characterLocomotion = m_Item.GetComponentInParent<UltimateCharacterLocomotion>();
            if (characterLocomotion != null)
                m_MeleeWeapon.RecoilAnimatorAudioStateSet.DeserializeAnimatorAudioStateSelector(m_Item,
                    characterLocomotion);
        }
        ...
        protected override Action GetDrawCallback()
        {
            ...
            baseCallback += () =>
            {
                    ...
                    if (states != null)
                        if (PropertyFromName("m_AllowAttackCombos").boolValue && states.Length == 1)
                            EditorGUILayout.HelpBox("Only 1 Use AnimatorAudio state has been added. " +
                                                    "Allow Attack Combos may need to be disabled in order for the animator to transition correctly.",
                                MessageType.Warning);
                    EditorGUI.indentLevel--;
                }
                ...
                if (Foldout("Recoil"))
                {
                    ...
                    {
                        EditorGUI.indentLevel++;
                        AnimatorAudioStateSetInspector.DrawAnimatorAudioStateSet(m_MeleeWeapon,
                            m_MeleeWeapon.RecoilAnimatorAudioStateSet, "m_RecoilAnimatorAudioStateSet", false,
                            ref m_ReorderableRecoilAnimatorAudioStateSetList, OnRecoilAnimatorAudioStateListDraw,
                            OnRecoilAnimatorAudioStateListSelect,
                            OnRecoilAnimatorAudioStateListAdd, OnRecoilAnimatorAudioStateListRemove,
                            SelectedRecoilAnimatorAudioStateSetIndexKey,
                            ref m_ReorderableRecoilAnimatorAudioStateSetAudioList, OnRecoilAudioListElementDraw,
                            OnRecoilAudioListAdd, OnRecoilAudioListRemove,
                            ref m_ReorderableRecoilAnimatorAudioStateSetStateList,
                            OnRecoilAnimatorAudioStateSetStateListDraw, OnRecoilAnimatorAudioStateSetStateListAdd,
                            OnRecoilAnimatorAudioStateSetStateListReorder, OnRecoilAnimatorAudioStateListRemove,
                            GetSelectedRecoilAnimatorAudioStateSetStateIndexKey(
                                EditorPrefs.GetInt(SelectedRecoilAnimatorAudioStateSetIndexKey)));
                        EditorGUI.indentLevel--;
                    }
                ...
                if (Foldout("Trail"))
                {
                    ...
                    if (trail.objectReferenceValue != null)
                    {
                        ...
                        InspectorUtility.DrawAnimationEventTrigger(target, "Attack Stop Trail Event",
                            PropertyFromName("m_AttackStopTrailEvent"));
                    }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipDraw(m_ReorderableRecoilAnimatorAudioStateSetAudioList, rect,
                index, m_MeleeWeapon.RecoilAnimatorAudioStateSet.States, SelectedRecoilAnimatorAudioStateSetIndexKey,
                target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipListAdd(list, m_MeleeWeapon.RecoilAnimatorAudioStateSet.States,
                SelectedRecoilAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipListRemove(list, m_MeleeWeapon.RecoilAnimatorAudioStateSet.States,
                SelectedRecoilAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateElementDraw(m_ReorderableRecoilAnimatorAudioStateSetList,
                m_MeleeWeapon.RecoilAnimatorAudioStateSet, rect, index, isActive, isFocused, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateListAdd(list, m_MeleeWeapon.RecoilAnimatorAudioStateSet,
                SelectedRecoilAnimatorAudioStateSetIndexKey);
        }
        ...
        private void OnRecoilAnimatorAudioStateListRemove(ReorderableList list)
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateListRemove(list,
                m_MeleeWeapon.RecoilAnimatorAudioStateSet, SelectedRecoilAnimatorAudioStateSetIndexKey);
        }
        ...
        {
            return c_EditorPrefsSelectedRecoilAnimatorAudioStateSetStateIndexKey + "." + target.GetType() + "." +
                   target.name + "." + index;
        }
        ...
        private void OnRecoilAnimatorAudioStateSetStateListDraw(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            var animatorAudioState =
                m_MeleeWeapon.RecoilAnimatorAudioStateSet.States[
                    EditorPrefs.GetInt(SelectedRecoilAnimatorAudioStateSetIndexKey)];
            ...
            if (index >= animatorAudioState.States.Length)
            {
                ...
                EditorPrefs.SetInt(
                    GetSelectedRecoilAnimatorAudioStateSetStateIndexKey(
                        EditorPrefs.GetInt(SelectedRecoilAnimatorAudioStateSetIndexKey)),
                    m_ReorderableRecoilAnimatorAudioStateSetStateList.index);
                return;
            }
        ...
        {
            StateInspector.OnStateListAdd(AddExistingRecoilAnimatorAudioStateSetStatePreset,
                CreateRecoilAnimatorAudioStateSetStatePreset);
        }
        ...
        private void AddExistingRecoilAnimatorAudioStateSetStatePreset()
        {
            ...
            var states = StateInspector.AddExistingPreset(animatorAudioState.GetType(), animatorAudioState.States,
                m_ReorderableRecoilAnimatorAudioStateSetStateList,
                GetSelectedRecoilAnimatorAudioStateSetStateIndexKey(
                    EditorPrefs.GetInt(SelectedRecoilAnimatorAudioStateSetIndexKey)));
            if (animatorAudioState.States.Length != states.Length)
            {
                InspectorUtility.SynchronizePropertyCount(states,
                    m_ReorderableRecoilAnimatorAudioStateSetStateList.serializedProperty);
                EditorUtility.RecordUndoDirtyObject(target, "Change Value");
        ...
        /// </summary>
        public static void OnHitboxListAdd(IMeleeWeaponPerspectiveProperties meleePerspective, ReorderableList list,
            string selectedKey)
        {
            ...
            EditorUtility.SetDirty(meleePerspective as Object);
        }

        /// <summary>
        ///     Remove the hitbox at the list index.
        /// </summary>
        public static void OnHitboxListRemove(IMeleeWeaponPerspectiveProperties meleePerspective, ReorderableList list,
            string selectedKey)
        {
            var hitboxes = new List<MeleeWeapon.MeleeHitbox>(meleePerspective.Hitboxes);

            // Remove the element.
            EditorUtility.RecordUndoDirtyObject(meleePerspective as Object, "Change Value");
            ...
            if (list.index == -1 && hitboxes.Count > 0) list.index = 0;
            EditorPrefs.SetInt(selectedKey, list.index);
            EditorUtility.SetDirty(meleePerspective as Object);
        }
        ...
        /// </summary>
        public static void DrawSelectedHitbox(IMeleeWeaponPerspectiveProperties meleePerspective,
            SerializedProperty hitboxProperty)
        {
            EditorGUI.BeginChangeCheck();
