...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items.Actions
{
    ...
    {
        private const string c_EditorPrefsSelectedReloadAnimatorAudioStateSetIndexKey =
            "Opsive.UltimateCharacterController.Editor.Inspectors.SelectedReloadAnimatorAudioStateSetIndex";

        private const string c_EditorPrefsSelectedReloadAnimatorAudioStateSetStateIndexKey =
            "Opsive.UltimateCharacterController.Editor.Inspectors.SelectedReloadAnimatorAudioStateSetStateIndex";
        ...
        private string SelectedReloadAnimatorAudioStateSetIndexKey =>
            c_EditorPrefsSelectedReloadAnimatorAudioStateSetIndexKey + "." + target.GetType() + "." + target.name +
            m_ShootableWeapon.ID;
        ...
        protected override void OnEnable()
        {
            ...
            m_ShootableWeapon.ReloadAnimatorAudioStateSet.DeserializeAnimatorAudioStateSelector(m_Item,
            ...
            baseCallback += () =>
            {
                ...
                if (Foldout("Firing"))
                {
                    ...
                    if (fireType.enumValueIndex != (int)ShootableWeapon.FireType.Instant)
                    {
                        ...
                        {
                            EditorGUI.indentLevel++;
                            m_ReorderableChargeAudioClipsList = AudioClipSetInspector.DrawAudioClipSet(
                                m_ShootableWeapon.ChargeAudioClipSet, m_ReorderableChargeAudioClipsList,
                                OnChargeAudioClipDraw, OnChargeAudioClipListAdd, OnChargeAudioClipListRemove);
                            EditorGUI.indentLevel--;
                        }
                    ...
                    EditorGUILayout.HelpBox(
                        "If a projectile prefab is specified then this projectile will be fired from the weapon. If no projectile is specified then a hitscan will be used.",
                        MessageType.Info);
                    ...
                    {
                        if ((projectile.objectReferenceValue as GameObject).GetComponent<Projectile>() == null)
                            EditorGUILayout.HelpBox("The projectile must have the Projectile component attached to it.",
                                MessageType.Error);
                        EditorGUI.indentLevel++;
                        ...
                        shootableWeapon.ProjectileStartLayer = EditorGUILayout.LayerField(new GUIContent(
                                "Projectile Start Layer",
                                "The layer that the projectile should occupy when initially spawned."),
                            shootableWeapon.ProjectileStartLayer);
                        shootableWeapon.ProjectileFiredLayer = EditorGUILayout.LayerField(new GUIContent(
                                "Projectile Fired Layer",
                                "The layer that the projectile object should change to after being fired."),
                            shootableWeapon.ProjectileFiredLayer);
                    ...
                    {
                        EditorGUI.indentLevel++;
                        m_ReorderableDryFireAudioClipsList = AudioClipSetInspector.DrawAudioClipSet(
                            m_ShootableWeapon.DryFireAudioClipSet, m_ReorderableDryFireAudioClipsList,
                            OnDryFireAudioClipDraw, OnDryFireAudioClipListAdd, OnDryFireAudioClipListRemove);
                        EditorGUI.indentLevel--;
                    }
                ...
                if (Foldout("Reload"))
                {
                    ...
                    var autoReloadString = Enum.GetNames(typeof(Reload.AutoReloadType));
                    autoReloadProperty.intValue = EditorGUILayout.MaskField(
                        new GUIContent("Auto Reload", autoReloadProperty.tooltip), autoReloadProperty.intValue,
                        autoReloadString);
                    ...
                    Utility.InspectorUtility.DrawAnimationEventTrigger(target, "Reload Event",
                        PropertyFromName("m_ReloadEvent"));
                    Utility.InspectorUtility.DrawAnimationEventTrigger(target, "Reload Complete Event",
                        PropertyFromName("m_ReloadCompleteEvent"));
                    EditorGUILayout.PropertyField(PropertyFromName("m_ReloadDetachAttachClip"));
                    Utility.InspectorUtility.DrawAnimationEventTrigger(target, "Reload Detach Clip Event",
                        PropertyFromName("m_ReloadDetachClipEvent"));
                    Utility.InspectorUtility.DrawAnimationEventTrigger(target, "Reload Show Projectile Event",
                        PropertyFromName("m_ReloadShowProjectileEvent"));
                    Utility.InspectorUtility.DrawAnimationEventTrigger(target, "Reload Attach Projectile Event",
                        PropertyFromName("m_ReloadAttachProjectileEvent"));
                    ...
                    if (reloadClipProperty.objectReferenceValue != null)
                    {
                        ...
                        Utility.InspectorUtility.DrawAnimationEventTrigger(target, "Reload Drop Clip Event",
                            PropertyFromName("m_ReloadDropClipEvent"));
                        EditorGUI.indentLevel--;
                    }

                    Utility.InspectorUtility.DrawAnimationEventTrigger(target, "Reload Attach Clip Event",
                        PropertyFromName("m_ReloadAttachClipEvent"));
                    if (Foldout("Animator Audio", "Reload"))
                    {
                        EditorGUI.indentLevel++;
                        AnimatorAudioStateSetInspector.DrawAnimatorAudioStateSet(m_ShootableWeapon,
                            m_ShootableWeapon.ReloadAnimatorAudioStateSet, "m_ReloadAnimatorAudioStateSet", true,
                            ref m_ReorderableReloadAnimatorAudioStateSetList, OnAnimatorAudioStateListDraw,
                            OnAnimatorAudioStateListSelect,
                            OnAnimatorAudioStateListAdd, OnAnimatorAudioStateListRemove,
                            SelectedReloadAnimatorAudioStateSetIndexKey,
                            ref m_ReorderableReloadAnimatorAudioStateSetAudioList, OnReloadAudioListElementDraw,
                            OnReloadAudioListAdd, OnReloadAudioListRemove,
                            ref m_ReorderableReloadAnimatorAudioStateSetStateList,
                            OnAnimatorAudioStateSetStateListDraw, OnAnimatorAudioStateSetStateListAdd,
                            OnAnimatorAudioStateSetStateListReorder, OnAnimatorAudioStateSetStateListRemove,
                            GetSelectedAnimatorAudioStateSetStateIndexKey(
                                EditorPrefs.GetInt(SelectedReloadAnimatorAudioStateSetIndexKey)));
                        EditorGUI.indentLevel--;
                    }
                    ...
                    {
                        EditorGUI.indentLevel++;
                        m_ReorderableReloadCompleteAudioClipsList = AudioClipSetInspector.DrawAudioClipSet(
                            m_ShootableWeapon.ReloadCompleteAudioClipSet, m_ReorderableReloadCompleteAudioClipsList,
                            OnReloadCompleteAudioClipDraw, OnReloadCompleteAudioClipListAdd,
        ...
        {
            AudioClipSetInspector.OnAudioClipDraw(m_ReorderableDryFireAudioClipsList, rect, index,
                m_ShootableWeapon.DryFireAudioClipSet, null);
        }
        ...
        {
            AudioClipSetInspector.OnAudioClipDraw(m_ReorderableReloadCompleteAudioClipsList, rect, index,
                m_ShootableWeapon.ReloadCompleteAudioClipSet, null);
        }
        ...
        {
            AudioClipSetInspector.OnAudioClipDraw(m_ReorderableChargeAudioClipsList, rect, index,
                m_ShootableWeapon.ChargeAudioClipSet, null);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipDraw(m_ReorderableReloadAnimatorAudioStateSetAudioList, rect,
                index, m_ShootableWeapon.ReloadAnimatorAudioStateSet.States,
                SelectedReloadAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipListAdd(list,
                m_ShootableWeapon.ReloadAnimatorAudioStateSet.States, SelectedReloadAnimatorAudioStateSetIndexKey,
                target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipListRemove(list,
                m_ShootableWeapon.ReloadAnimatorAudioStateSet.States, SelectedReloadAnimatorAudioStateSetIndexKey,
                target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateElementDraw(m_ReorderableReloadAnimatorAudioStateSetList,
                m_ShootableWeapon.ReloadAnimatorAudioStateSet, rect, index, isActive, isFocused, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateListAdd(list,
                m_ShootableWeapon.ReloadAnimatorAudioStateSet, SelectedReloadAnimatorAudioStateSetIndexKey);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateListRemove(list,
                m_ShootableWeapon.ReloadAnimatorAudioStateSet, SelectedReloadAnimatorAudioStateSetIndexKey);
        }
        ...
        {
            return c_EditorPrefsSelectedReloadAnimatorAudioStateSetStateIndexKey + "." + target.GetType() + "." +
                   target.name + "." + index;
        }
        ...
        private void OnAnimatorAudioStateSetStateListDraw(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            var animatorAudioState =
                m_ShootableWeapon.ReloadAnimatorAudioStateSet.States[
                    EditorPrefs.GetInt(SelectedReloadAnimatorAudioStateSetIndexKey)];
            ...
            if (index >= animatorAudioState.States.Length)
            {
                ...
                EditorPrefs.SetInt(
                    GetSelectedAnimatorAudioStateSetStateIndexKey(
                        EditorPrefs.GetInt(SelectedReloadAnimatorAudioStateSetIndexKey)),
                    m_ReorderableReloadAnimatorAudioStateSetStateList.index);
                return;
            }
        ...
        {
            StateInspector.OnStateListAdd(AddExistingAnimatorAudioStateSetStatePreset,
                CreateAnimatorAudioStateSetStatePreset);
        }
        ...
        private void AddExistingAnimatorAudioStateSetStatePreset()
        {
            ...
            var states = StateInspector.AddExistingPreset(animatorAudioState.GetType(), animatorAudioState.States,
                m_ReorderableReloadAnimatorAudioStateSetStateList,
                GetSelectedAnimatorAudioStateSetStateIndexKey(
                    EditorPrefs.GetInt(SelectedReloadAnimatorAudioStateSetIndexKey)));
            if (animatorAudioState.States.Length != states.Length)
            {
                Utility.InspectorUtility.SynchronizePropertyCount(states,
                    m_ReorderableReloadAnimatorAudioStateSetStateList.serializedProperty);
                EditorUtility.RecordUndoDirtyObject(target, "Change Value");
        ...
        private void OnAnimatorAudioStateSetStateListRemove(ReorderableList list)
        {
            ...
            var states = StateInspector.OnStateListRemove(animatorAudioState.States,
                GetSelectedAnimatorAudioStateSetStateIndexKey(
                    EditorPrefs.GetInt(SelectedReloadAnimatorAudioStateSetIndexKey)), list);
            if (animatorAudioState.States.Length != states.Length)
            {
                Utility.InspectorUtility.SynchronizePropertyCount(states,
                    m_ReorderableReloadAnimatorAudioStateSetStateList.serializedProperty);
