...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items.Actions
{
    ...
    {
        private const string c_EditorPrefsSelectedImpactAnimatorAudioStateSetIndexKey =
            "Opsive.UltimateCharacterController.Editor.Inspectors.SelectedImpactAnimatorAudioStateSetIndex";

        private const string c_EditorPrefsSelectedImpactAnimatorAudioStateSetStateIndexKey =
            "Opsive.UltimateCharacterController.Editor.Inspectors.SelectedImpactAnimatorAudioStateSetStateIndex";
        ...
        private string SelectedImpactAnimatorAudioStateSetIndexKey =>
            c_EditorPrefsSelectedImpactAnimatorAudioStateSetStateIndexKey + "." + target.GetType() + "." + target.name;
        ...
        protected override Action GetDrawCallback()
        {
            ...
            baseCallback += () =>
            {
                ...
                var attributeName = InspectorUtility.DrawAttribute(m_AttributeManager,
                    (target as Shield).DurabilityAttributeName, "Durability Attribute");
                ...
                if (Foldout("Impact"))
                {
                    ...
                    InspectorUtility.DrawAnimationEventTrigger(target, "Impact Complete Event",
                        PropertyFromName("m_ImpactCompleteEvent"));
                    if (Foldout("Animator Audio", "Impact"))
                    {
                        EditorGUI.indentLevel++;
                        AnimatorAudioStateSetInspector.DrawAnimatorAudioStateSet(m_Shield,
                            m_Shield.ImpactAnimatorAudioStateSet, "m_ImpactAnimatorAudioStateSet", true,
                            ref m_ReorderableImpactAnimatorAudioStateSetList, OnImpactAnimatorAudioStateListDraw,
                            OnImpactAnimatorAudioStateListSelect,
                            OnImpactAnimatorAudioStateListAdd, OnImpactAnimatorAudioStateListRemove,
                            SelectedImpactAnimatorAudioStateSetIndexKey,
                            ref m_ReorderableImpactAnimatorAudioStateSetAudioList, OnImpactAudioListElementDraw,
                            OnImpactAudioListAdd, OnImpactAudioListRemove,
                            ref m_ReorderableImpactAnimatorAudioStateSetStateList,
                            OnImpactAnimatorAudioStateSetStateListDraw, OnImpactAnimatorAudioStateSetStateListAdd,
                            OnImpactAnimatorAudioStateSetStateListReorder, OnImpactAnimatorAudioStateListRemove,
                            GetSelectedImpactAnimatorAudioStateSetStateIndexKey(
                                EditorPrefs.GetInt(SelectedImpactAnimatorAudioStateSetIndexKey)));
                        EditorGUI.indentLevel--;
                    }
                }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipDraw(m_ReorderableImpactAnimatorAudioStateSetAudioList, rect,
                index, m_Shield.ImpactAnimatorAudioStateSet.States, SelectedImpactAnimatorAudioStateSetIndexKey,
                target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipListAdd(list, m_Shield.ImpactAnimatorAudioStateSet.States,
                SelectedImpactAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipListRemove(list, m_Shield.ImpactAnimatorAudioStateSet.States,
                SelectedImpactAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateElementDraw(m_ReorderableImpactAnimatorAudioStateSetList,
                m_Shield.ImpactAnimatorAudioStateSet, rect, index, isActive, isFocused, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateListAdd(list, m_Shield.ImpactAnimatorAudioStateSet,
                SelectedImpactAnimatorAudioStateSetIndexKey);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateListRemove(list, m_Shield.ImpactAnimatorAudioStateSet,
                SelectedImpactAnimatorAudioStateSetIndexKey);
        }
        ...
        {
            return c_EditorPrefsSelectedImpactAnimatorAudioStateSetStateIndexKey + "." + target.GetType() + "." +
                   target.name + "." + index;
        }
        ...
        private void OnImpactAnimatorAudioStateSetStateListDraw(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            var animatorAudioState =
                m_Shield.ImpactAnimatorAudioStateSet.States[
                    EditorPrefs.GetInt(SelectedImpactAnimatorAudioStateSetIndexKey)];
            ...
            if (index >= animatorAudioState.States.Length)
            {
                ...
                EditorPrefs.SetInt(
                    GetSelectedImpactAnimatorAudioStateSetStateIndexKey(
                        EditorPrefs.GetInt(SelectedImpactAnimatorAudioStateSetIndexKey)),
                    m_ReorderableImpactAnimatorAudioStateSetStateList.index);
                return;
            }
        ...
        {
            StateInspector.OnStateListAdd(AddExistingImpactAnimatorAudioStateSetStatePreset,
                CreateImpactAnimatorAudioStateSetStatePreset);
        }
        ...
        private void AddExistingImpactAnimatorAudioStateSetStatePreset()
        {
            ...
            var states = StateInspector.AddExistingPreset(animatorAudioState.GetType(), animatorAudioState.States,
                m_ReorderableImpactAnimatorAudioStateSetStateList,
                GetSelectedImpactAnimatorAudioStateSetStateIndexKey(
                    EditorPrefs.GetInt(SelectedImpactAnimatorAudioStateSetIndexKey)));
            if (animatorAudioState.States.Length != states.Length)
            {
                InspectorUtility.SynchronizePropertyCount(states,
                    m_ReorderableImpactAnimatorAudioStateSetStateList.serializedProperty);
                EditorUtility.RecordUndoDirtyObject(target, "Change Value");
        ...
        {
            m_Shield.ImpactAnimatorAudioStateSet.DeserializeAnimatorAudioStateSelector(m_Item,
