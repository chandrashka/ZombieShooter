    ...
    public class RideableInspectorDrawer : AbilityInspectorDrawer
    {
        ...
        public override Action GetEditorCallback(Ability ability, Object parent)
        {
            ...
            baseCallback += () =>
            {
                ...
                GUI.enabled = rideableAbility.LeftDismountCollider == null ||
                ...
                GUI.enabled = rideableAbility.LeftDismountCollider != null ||
                              rideableAbility.RightDismountCollider != null;
                if (GUILayout.Button("Remove Dismount Colliders")) RemoveDismountColliders(rideableAbility);
                GUI.enabled = true;
        ...
        private void AddDismountColliders(Rideable rideableAbility, GameObject parent)
        {
            ...
            rideableAbility.LeftDismountCollider =
                CreateCollider(parent, "Left Dismount Collider", new Vector3(-0.9f, 1, 0));
            rideableAbility.RightDismountCollider =
                CreateCollider(parent, "Right Dismount Collider", new Vector3(0.9f, 1, 0));
        }
        ...
        private void RemoveDismountColliders(Rideable rideableAbility)
        {
            ...
            {
                Object.DestroyImmediate(rideableAbility.LeftDismountCollider.gameObject, true);
                rideableAbility.LeftDismountCollider = null;
            }

            if (rideableAbility.RightDismountCollider != null)
            {
                Object.DestroyImmediate(rideableAbility.RightDismountCollider.gameObject, true);
                rideableAbility.RightDismountCollider = null;
            }
        }
    }
