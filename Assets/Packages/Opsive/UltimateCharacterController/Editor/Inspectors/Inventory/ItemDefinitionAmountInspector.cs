...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Inventory
{
    ...
    public static class ItemDefinitionAmountInspector
    {
        ...
        {
            EditorGUI.LabelField(new Rect(rect.x, rect.y, rect.width - c_ValueWidth, EditorGUIUtility.singleLineHeight),
                "Item Definition");
            EditorGUI.LabelField(
                new Rect(rect.x + 12 + (rect.width - c_ValueWidth), rect.y, c_ValueWidth,
                    EditorGUIUtility.singleLineHeight), "Amount");
        }

        /// <summary>
        ///     Draws the ItemDefinitionAmount ReordableList element.
        /// </summary>
        public static void OnItemDefinitionAmountElementDraw(SerializedProperty itemIdentifierAmountProperties,
            Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            EditorGUI.PropertyField(objRect,
                itemIdentifierAmountProperties.GetArrayElementAtIndex(index).FindPropertyRelative("ItemDefinition"),
                new GUIContent());
            ...
            EditorGUI.PropertyField(valueRect,
                itemIdentifierAmountProperties.GetArrayElementAtIndex(index).FindPropertyRelative("Amount"),
                new GUIContent());
        }
    }
}