...
{
    /// <summary>
    ///     Uses Unity's TreeView class to create a single column tree view that does not have any children. The elements can
    ///     be reordered and searched.
    /// </summary>
    public class FlatTreeView<T> : TreeView where T : TreeModal
    {
        ...
        public Action TreeChange { get; set; }
        ...
        protected override IList<TreeViewItem> BuildRows(TreeViewItem root)
        {
            ...
            else
            {
                ...
                for (var i = 0; i < rowCount; ++i) m_Rows.Add(new TreeViewItem(i, -1));
        ...
        protected override void SetupDragAndDrop(SetupDragAndDropArgs args)
        {
            ...
            for (var j = 0; j < args.draggedItemIDs.Count; ++j)
            ...
            DragAndDrop.objectReferences = new Object[] { }; // Required for dragging to work.
        ...
        protected override DragAndDropVisualMode HandleDragAndDrop(DragAndDropArgs args)
        {
            ...
            switch (args.dragAndDropPosition)
            {
                ...
                case DragAndDropPosition.OutsideItems
                    : // The item will be dropped to the last row if it is outside the tree.
                {
                    if (args.performDrop)
                        // Do the drop.
        ...
        public virtual void OnDropDraggedElementsAtIndex(List<TreeViewItem> draggedRows, int insertIndex)
        {
            ...
            for (var i = 0; i < draggedRows.Count; ++i) draggedElements.Add(draggedRows[i].id);
    ...
    public abstract class TreeModal
    {
        ...
        public Action BeforeModalChange
        {
            get => m_BeforeModalChange;
            set => m_BeforeModalChange = value;
        }

        public Action AfterModalChange
        {
            get => m_AfterModalChange;
            set => m_AfterModalChange = value;
        }
        ...
        public virtual float GetRowHeight(TreeViewItem item, TreeViewState state)
        {
            return -1;
        }
        ...
        public virtual bool MatchesSearch(int id, string searchString)
        {
            return false;
        }
    }
