...
namespace Opsive.Shared.Editor.Inspectors.Game
{
    ...
    public class SchedulerBaseInspector : UnityEditor.Editor
    {
        /// <summary>
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("Update Events Scheduled: " +
                                       (scheduler.ActiveUpdateEventCount + scheduler.ActiveFixedUpdateEventCount));
            if (scheduler.ActiveUpdateEventCount > 0)
            {
                ...
                for (var i = 0; i < scheduler.ActiveUpdateEventCount + scheduler.ActiveFixedUpdateEventCount; ++i)
                {
                    ...
                    else if (scheduler.ActiveUpdateEvents[updateIndex].EndTime <=
                             scheduler.ActiveFixedUpdateEvents[fixedUpdateIndex].EndTime)
                    {
                    ...
                    if (scheduledEvent.EndTime == -1)
                        ...
                        EditorGUILayout.LabelField((scheduledEvent.EndTime - Time.time).ToString("0.##"),
                            GUILayout.Width(50));
                    var targetName = "";
                    var methodName = "";
                    ...
                    if (scheduledEvent.Method != null) methodName = scheduledEvent.Method.Name;
