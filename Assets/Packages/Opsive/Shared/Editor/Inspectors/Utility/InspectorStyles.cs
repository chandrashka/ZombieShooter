...
namespace Opsive.Shared.Editor.Inspectors.Utility
{
    ...
    public static class InspectorStyles
    {
        ...
        public static Texture2D AddIcon
        {
            ...
            {
                if (s_AddIcon == null)
                    s_AddIcon = LoadTexture("aff49c3d1ef455d488b96b6ed77550b0", "21eff06b5e4af0e478ea75270aca329a");
                return s_AddIcon;
            }
        }

        public static Texture2D ActivateIcon
        {
            get
            {
                if (s_ActivateIcon == null)
                    s_ActivateIcon = LoadTexture("e152e9061481aab429f2b07a70c12d2e",
                        "a4d2cff4316a64946b786d75f681cd33");
                return s_ActivateIcon;
            }
        }
        ...
        public static Texture2D DeleteIcon
        {
            get
            {
                if (s_DeleteIcon == null)
                    s_DeleteIcon = LoadTexture("01290b743a16c0946b599beba004ca10", "cc50d62765d4d79479ddf540cac0989b");
                return s_DeleteIcon;
            }
        }

        public static Texture2D DuplicateIcon
        {
            get
            {
                if (s_DuplicateIcon == null)
                    s_DuplicateIcon = LoadTexture("ba8a6a7b5fe943b48bef5d532c257d38",
                        "4d9d8217015eee543ac1b745a096016d");
                return s_DuplicateIcon;
            }
        }
        ...
        public static Texture2D InfoIcon
        {
            ...
            {
                if (s_InfoIcon == null)
                    s_InfoIcon = LoadTexture("487848bbccf6d414bacf8e840467e094", "14890942c77df924d95bfdf229fcffe5");
                return s_InfoIcon;
            }
        }

        public static Texture2D PersistIcon
        {
            get
            {
                if (s_PersistIcon == null)
                    s_PersistIcon = LoadTexture("ee727c0b6401c8f4db0126f95f518541", "20a2a7d0dc8114f4083f51b8883d06b6");
                return s_PersistIcon;
            }
        }
        ...
        public static Texture2D RemoveIcon
        {
            get
            {
                if (s_RemoveIcon == null)
                    s_RemoveIcon = LoadTexture("71fd51a904de3f14086279a41bec5b78", "088c80b2883e964498350b2075ecde18");
                return s_RemoveIcon;
            }
        }
        ...
        public static Texture2D UpdateIcon
        {
            get
            {
                if (s_UpdateIcon == null)
                    s_UpdateIcon = LoadTexture("c1502f6cab2c3a542bb77c572d8567de", "ffb6d9e2798b5f8418dd9d5c9fc9118f");
                return s_UpdateIcon;
            }
        }
