...
namespace Opsive.Shared.StateSystem
{
    ...
    {
        [Tooltip("The serialized properties.")] [SerializeField]
        protected Serialization m_Data;
        ...
        public override void Initialize(object obj, MemberVisibility visibility)
        {
            ...
            for (var i = 0; i < m_Data.ValueHashes.Length; ++i) valuePositionMap.Add(m_Data.ValueHashes[i], i);
            ...
            for (var i = 0; i < properties.Length; ++i)
            {
                ...
                int position;
                if (!valuePositionMap.TryGetValue(hash, out position)) continue;
